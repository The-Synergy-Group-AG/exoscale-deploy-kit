...
echo "  ✅ dashboard.html = service dashboard (224 services)"
cp "${SCRIPT_DIR}/frontend/monitoring.html" "${SERVICE_DIR}/monitoring.html" 2>/dev/null || echo "  ⚠ monitoring.html not found"
echo "  ✅ monitoring.html = monitoring command center (Plan 170)"
