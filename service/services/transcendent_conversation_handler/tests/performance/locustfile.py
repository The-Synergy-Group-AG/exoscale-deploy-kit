"""Performance tests for transcendent_conversation_handler.
Port: 8175 | Rate limit: 1000 rpm
...
class TranscendentConversationHandlerUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/transcendent_conversation_handler/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/transcendent_conversation_handler/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.post("/api/transcendent_conversation_handler/ai/process",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/transcendent_conversation_handler/health")
