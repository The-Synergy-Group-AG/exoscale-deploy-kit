"""Shared test fixtures for transcendent_conversation_handler.
Domain: ai | Port: 8175 | NS: jtp
...
SERVICE_NAME   = "transcendent_conversation_handler"
SERVICE_PORT   = 8175
...
def service_name():
    return "transcendent_conversation_handler"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/transcendent_conversation_handler"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-transcendent_conversation_handler",
        "X-Service-Name": "transcendent_conversation_handler",
        "X-Domain": "ai",
    }
