"""Shared test fixtures for referral_tracking_service.
Domain: workflow | Port: 8114 | NS: jtp
...
SERVICE_NAME   = "referral_tracking_service"
SERVICE_PORT   = 8114
...
def service_name():
    return "referral_tracking_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/referral_tracking_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-referral_tracking_service",
        "X-Service-Name": "referral_tracking_service",
        "X-Domain": "workflow",
    }
