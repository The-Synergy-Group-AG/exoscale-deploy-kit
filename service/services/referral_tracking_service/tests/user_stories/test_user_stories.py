"""User Story Acceptance Tests — referral_tracking_service
US: US-001..US-0601 (241 stories) | Port: 8114 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/referral_tracking_service"
SERVICE_PORT  = 8114


class TestReferralTrackingServiceUserStories:
