"""Performance tests for referral_tracking_service.
Port: 8114 | Rate limit: 1000 rpm
...
class ReferralTrackingServiceUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/referral_tracking_service/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/referral_tracking_service/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/referral_tracking_service/workflows",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/referral_tracking_service/health")
