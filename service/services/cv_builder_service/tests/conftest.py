"""Shared test fixtures for cv_builder_service.
Domain: career | Port: 8128 | NS: jtp
...
SERVICE_NAME   = "cv_builder_service"
SERVICE_PORT   = 8128
...
def service_base(gateway_url):
    return f"{gateway_url}/api/cv_builder_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-cv_builder_service",
        "X-Service-Name": "cv_builder_service",
        "X-Domain": "career",
    }
