"""Shared test fixtures for ai_biological_synthesis_engine.
Domain: ai | Port: 8209 | NS: jtp
...
SERVICE_NAME   = "ai_biological_synthesis_engine"
SERVICE_PORT   = 8209
...
def service_name():
    return "ai_biological_synthesis_engine"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/ai_biological_synthesis_engine"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-ai_biological_synthesis_engine",
        "X-Service-Name": "ai_biological_synthesis_engine",
        "X-Domain": "ai",
    }
