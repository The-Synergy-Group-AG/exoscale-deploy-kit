"""Shared test fixtures for data_science_platform_ai.
Domain: analytics | Port: 8089 | NS: jtp
...
SERVICE_NAME   = "data_science_platform_ai"
SERVICE_PORT   = 8089
...
def service_name():
    return "data_science_platform_ai"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/data_science_platform_ai"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-data_science_platform_ai",
        "X-Service-Name": "data_science_platform_ai",
        "X-Domain": "analytics",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "data_science_platform_ai",
        "domain": "analytics",
        "resource_tier": "medium",
        "port": 8089,
        "harmony_target": 0.997,
