"""Performance tests for data_science_platform_ai.
Port: 8089 | Rate limit: 1000 rpm
...
class DataSciencePlatformAiUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/data_science_platform_ai/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/data_science_platform_ai/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/data_science_platform_ai/analytics/dashboard",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/data_science_platform_ai/health")
