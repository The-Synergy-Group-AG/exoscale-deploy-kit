"""Performance tests for decision_support_service.
Port: 8110 | Rate limit: 1000 rpm
...
class DecisionSupportServiceUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/decision_support_service/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/decision_support_service/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.post("/api/decision_support_service/ai/process",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/decision_support_service/health")
