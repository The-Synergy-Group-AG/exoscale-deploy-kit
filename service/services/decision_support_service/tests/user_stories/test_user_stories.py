"""User Story Acceptance Tests — decision_support_service
US: US-410..US-0683 (90 stories) | Port: 8110 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/decision_support_service"
SERVICE_PORT  = 8110


class TestDecisionSupportServiceUserStories:
