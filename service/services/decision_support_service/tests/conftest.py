"""Shared test fixtures for decision_support_service.
Domain: ai | Port: 8110 | NS: jtp
...
SERVICE_NAME   = "decision_support_service"
SERVICE_PORT   = 8110
...
def service_name():
    return "decision_support_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/decision_support_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-decision_support_service",
        "X-Service-Name": "decision_support_service",
        "X-Domain": "ai",
    }
