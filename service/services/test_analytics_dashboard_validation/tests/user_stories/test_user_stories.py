"""User Story Acceptance Tests — test_analytics_dashboard_validation
US: US-097..US-0630 (89 stories) | Port: 8225 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/test_analytics_dashboard_validation"
SERVICE_PORT  = 8225


class TestTestAnalyticsDashboardValidationUserStories:
