"""Performance tests for test_analytics_dashboard_validation.
Port: 8225 | Rate limit: 1000 rpm
...
class TestAnalyticsDashboardValidationUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/test_analytics_dashboard_validation/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/test_analytics_dashboard_validation/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/test_analytics_dashboard_validation/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/test_analytics_dashboard_validation/health")
