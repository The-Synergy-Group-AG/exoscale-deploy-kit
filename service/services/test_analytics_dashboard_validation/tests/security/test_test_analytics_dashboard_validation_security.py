"""Security tests for test_analytics_dashboard_validation.
Port: 8225 | Encryption: advanced | Audit retention: 365 days
OWASP Top 10 — Plan 123 Phase 3 (7 security tests).
Variables from CENTRAL_VARIABLE_REGISTRY.
"""
import pytest, httpx

SERVICE_BASE  = "http://151.145.202.116:30671/api/test_analytics_dashboard_validation"
SERVICE_PORT  = 8225
ENC_LEVEL     = "advanced"


class TestTestAnalyticsDashboardValidationSecurity:
