"""Shared test fixtures for test_analytics_dashboard_validation.
Domain: monitoring | Port: 8225 | NS: jtp
...
SERVICE_NAME   = "test_analytics_dashboard_validation"
SERVICE_PORT   = 8225
...
def service_name():
    return "test_analytics_dashboard_validation"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/test_analytics_dashboard_validation"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-test_analytics_dashboard_validation",
        "X-Service-Name": "test_analytics_dashboard_validation",
        "X-Domain": "monitoring",
    }
