"""Performance tests for security_policy_enforcer.
Port: 8106 | Rate limit: 1000 rpm
...
class SecurityPolicyEnforcerUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/security_policy_enforcer/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/security_policy_enforcer/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/security_policy_enforcer/security/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/security_policy_enforcer/health")
