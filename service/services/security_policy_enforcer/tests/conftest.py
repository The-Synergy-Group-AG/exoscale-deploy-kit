"""Shared test fixtures for security_policy_enforcer.
Domain: security | Port: 8106 | NS: jtp
...
SERVICE_NAME   = "security_policy_enforcer"
SERVICE_PORT   = 8106
...
def service_name():
    return "security_policy_enforcer"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/security_policy_enforcer"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-security_policy_enforcer",
        "X-Service-Name": "security_policy_enforcer",
        "X-Domain": "security",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "security_policy_enforcer",
        "domain": "security",
        "resource_tier": "large",
        "port": 8106,
        "harmony_target": 0.997,
