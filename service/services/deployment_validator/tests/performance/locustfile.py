"""Performance tests for deployment_validator.
Port: 8205 | Rate limit: 1000 rpm
...
class DeploymentValidatorUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/deployment_validator/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/deployment_validator/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/deployment_validator/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/deployment_validator/health")
