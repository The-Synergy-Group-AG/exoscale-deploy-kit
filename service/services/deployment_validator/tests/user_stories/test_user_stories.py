"""User Story Acceptance Tests — deployment_validator
US: US-097..US-0630 (89 stories) | Port: 8205 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/deployment_validator"
SERVICE_PORT  = 8205


class TestDeploymentValidatorUserStories:
