"""Shared test fixtures for deployment_validator.
Domain: monitoring | Port: 8205 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/deployment_validator"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-deployment_validator",
        "X-Service-Name": "deployment_validator",
        "X-Domain": "monitoring",
    }
