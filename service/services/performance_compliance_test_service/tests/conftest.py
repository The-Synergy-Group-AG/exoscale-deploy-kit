"""Shared test fixtures for performance_compliance_test_service.
Domain: compliance | Port: 8123 | NS: jtp
...
SERVICE_NAME   = "performance_compliance_test_service"
SERVICE_PORT   = 8123
...
def service_name():
    return "performance_compliance_test_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/performance_compliance_test_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-performance_compliance_test_service",
        "X-Service-Name": "performance_compliance_test_service",
        "X-Domain": "compliance",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "performance_compliance_test_service",
        "domain": "compliance",
        "resource_tier": "medium",
        "port": 8123,
        "harmony_target": 0.997,
