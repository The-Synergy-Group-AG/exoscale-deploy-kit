"""User Story Acceptance Tests — performance_compliance_test_service
US: US-357..US-0611 (55 stories) | Port: 8123 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/performance_compliance_test_service"
SERVICE_PORT  = 8123


class TestPerformanceComplianceTestServiceUserStories:
