"""Shared test fixtures for analytics_service.
Domain: analytics | Port: 8202 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/analytics_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-analytics_service",
        "X-Service-Name": "analytics_service",
        "X-Domain": "analytics",
    }
