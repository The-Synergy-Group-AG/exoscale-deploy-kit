"""Shared test fixtures for workflow_engines_service.
Domain: workflow | Port: 8184 | NS: jtp
...
SERVICE_NAME   = "workflow_engines_service"
SERVICE_PORT   = 8184
...
def service_name():
    return "workflow_engines_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/workflow_engines_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-workflow_engines_service",
        "X-Service-Name": "workflow_engines_service",
        "X-Domain": "workflow",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "workflow_engines_service",
        "domain": "workflow",
        "resource_tier": "medium",
        "port": 8184,
        "harmony_target": 0.997,
