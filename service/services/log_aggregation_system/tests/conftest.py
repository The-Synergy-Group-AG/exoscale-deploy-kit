"""Shared test fixtures for log_aggregation_system.
Domain: monitoring | Port: 8185 | NS: jtp
...
SERVICE_NAME   = "log_aggregation_system"
SERVICE_PORT   = 8185
...
def service_base(gateway_url):
    return f"{gateway_url}/api/log_aggregation_system"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-log_aggregation_system",
        "X-Service-Name": "log_aggregation_system",
        "X-Domain": "monitoring",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "log_aggregation_system",
        "domain": "monitoring",
        "resource_tier": "small",
        "port": 8185,
        "harmony_target": 0.997,
