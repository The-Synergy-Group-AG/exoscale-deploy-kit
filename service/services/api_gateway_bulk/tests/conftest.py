"""Shared test fixtures for api_gateway_bulk.
Domain: security | Port: 8169 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/api_gateway_bulk"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-api_gateway_bulk",
        "X-Service-Name": "api_gateway_bulk",
        "X-Domain": "security",
    }
