"""User Story Acceptance Tests — rav_compliance_service
US: US-357..US-0611 (55 stories) | Port: 8187 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/rav_compliance_service"
SERVICE_PORT  = 8187


class TestRavComplianceServiceUserStories:
