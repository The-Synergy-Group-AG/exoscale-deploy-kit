"""Performance tests for rav_compliance_service.
Port: 8187 | Rate limit: 1000 rpm
...
class RavComplianceServiceUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/rav_compliance_service/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/rav_compliance_service/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/rav_compliance_service/compliance/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/rav_compliance_service/health")
