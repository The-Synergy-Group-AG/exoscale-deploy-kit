"""Shared test fixtures for rav_compliance_service.
Domain: compliance | Port: 8187 | NS: jtp
...
SERVICE_NAME   = "rav_compliance_service"
SERVICE_PORT   = 8187
...
def service_base(gateway_url):
    return f"{gateway_url}/api/rav_compliance_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-rav_compliance_service",
        "X-Service-Name": "rav_compliance_service",
        "X-Domain": "compliance",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "rav_compliance_service",
        "domain": "compliance",
        "resource_tier": "medium",
        "port": 8187,
        "harmony_target": 0.997,
