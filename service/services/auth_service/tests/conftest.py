"""Shared test fixtures for auth_service.
Domain: authentication | Port: 8215 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/auth_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-auth_service",
