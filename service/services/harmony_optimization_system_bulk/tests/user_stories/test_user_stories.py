"""User Story Acceptance Tests — harmony_optimization_system_bulk
US: US-143..US-279 (115 stories) | Port: 8244 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/harmony_optimization_system_bulk"
SERVICE_PORT  = 8244


class TestHarmonyOptimizationSystemBulkUserStories:
