"""Shared test fixtures for harmony_optimization_system_bulk.
Domain: biological | Port: 8244 | NS: jtp
...
SERVICE_NAME   = "harmony_optimization_system_bulk"
SERVICE_PORT   = 8244
...
def service_name():
    return "harmony_optimization_system_bulk"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/harmony_optimization_system_bulk"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-harmony_optimization_system_bulk",
        "X-Service-Name": "harmony_optimization_system_bulk",
        "X-Domain": "biological",
    }
