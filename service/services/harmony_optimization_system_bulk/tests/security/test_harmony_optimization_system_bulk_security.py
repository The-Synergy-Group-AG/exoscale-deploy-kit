"""Security tests for harmony_optimization_system_bulk.
Port: 8244 | Encryption: advanced | Audit retention: 365 days
OWASP Top 10 — Plan 123 Phase 3 (7 security tests).
Variables from CENTRAL_VARIABLE_REGISTRY.
"""
import pytest, httpx

SERVICE_BASE  = "http://151.145.202.116:30671/api/harmony_optimization_system_bulk"
SERVICE_PORT  = 8244
ENC_LEVEL     = "advanced"


class TestHarmonyOptimizationSystemBulkSecurity:
