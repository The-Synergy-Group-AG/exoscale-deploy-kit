"""Performance tests for communication_encryptor.
Port: 8286 | Rate limit: 1000 rpm
...
class CommunicationEncryptorUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/communication_encryptor/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/communication_encryptor/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/communication_encryptor/security/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/communication_encryptor/health")
