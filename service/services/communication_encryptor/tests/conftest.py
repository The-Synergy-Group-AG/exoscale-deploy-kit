"""Shared test fixtures for communication_encryptor.
Domain: security | Port: 8286 | NS: jtp
...
SERVICE_NAME   = "communication_encryptor"
SERVICE_PORT   = 8286
...
def service_name():
    return "communication_encryptor"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/communication_encryptor"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-communication_encryptor",
        "X-Service-Name": "communication_encryptor",
        "X-Domain": "security",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "communication_encryptor",
        "domain": "security",
        "resource_tier": "large",
        "port": 8286,
        "harmony_target": 0.997,
