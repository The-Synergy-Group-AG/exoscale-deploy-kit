"""Shared test fixtures for application_service.
Domain: general | Port: 8213 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/application_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-application_service",
        "X-Service-Name": "application_service",
        "X-Domain": "general",
    }
