"""User Story Acceptance Tests — application_service
US: US-001..US-0601 (241 stories) | Port: 8213 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/application_service"
SERVICE_PORT  = 8213


class TestApplicationServiceUserStories:
