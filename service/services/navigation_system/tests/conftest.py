"""Shared test fixtures for navigation_system.
Domain: workflow | Port: 8241 | NS: jtp
...
SERVICE_NAME   = "navigation_system"
SERVICE_PORT   = 8241
...
def service_base(gateway_url):
    return f"{gateway_url}/api/navigation_system"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-navigation_system",
        "X-Service-Name": "navigation_system",
        "X-Domain": "workflow",
    }
