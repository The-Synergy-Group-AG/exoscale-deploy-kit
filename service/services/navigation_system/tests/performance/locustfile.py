"""Performance tests for navigation_system.
Port: 8241 | Rate limit: 1000 rpm
...
class NavigationSystemUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/navigation_system/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/navigation_system/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/navigation_system/workflows",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/navigation_system/health")
