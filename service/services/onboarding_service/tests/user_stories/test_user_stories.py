"""User Story Acceptance Tests — onboarding_service
US: US-001..US-0601 (241 stories) | Port: 8236 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/onboarding_service"
SERVICE_PORT  = 8236


class TestOnboardingServiceUserStories:
