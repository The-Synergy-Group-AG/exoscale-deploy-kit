"""User Story Acceptance Tests — biological_analytics_performance_test
US: US-097..US-0630 (89 stories) | Port: 8280 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/biological_analytics_performance_test"
SERVICE_PORT  = 8280


class TestBiologicalAnalyticsPerformanceTestUserStories:
