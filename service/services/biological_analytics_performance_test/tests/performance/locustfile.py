"""Performance tests for biological_analytics_performance_test.
Port: 8280 | Rate limit: 1000 rpm
...
class BiologicalAnalyticsPerformanceTestUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/biological_analytics_performance_test/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/biological_analytics_performance_test/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/biological_analytics_performance_test/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/biological_analytics_performance_test/health")
