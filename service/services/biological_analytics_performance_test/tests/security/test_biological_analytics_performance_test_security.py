"""Security tests for biological_analytics_performance_test.
Port: 8280 | Encryption: advanced | Audit retention: 365 days
OWASP Top 10 — Plan 123 Phase 3 (7 security tests).
Variables from CENTRAL_VARIABLE_REGISTRY.
"""
import pytest, httpx

SERVICE_BASE  = "http://151.145.202.116:30671/api/biological_analytics_performance_test"
SERVICE_PORT  = 8280
ENC_LEVEL     = "advanced"


class TestBiologicalAnalyticsPerformanceTestSecurity:
