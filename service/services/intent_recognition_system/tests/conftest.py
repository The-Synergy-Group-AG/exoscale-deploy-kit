"""Shared test fixtures for intent_recognition_system.
Domain: ai | Port: 8140 | NS: jtp
...
SERVICE_NAME   = "intent_recognition_system"
SERVICE_PORT   = 8140
...
def service_name():
    return "intent_recognition_system"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/intent_recognition_system"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-intent_recognition_system",
        "X-Service-Name": "intent_recognition_system",
        "X-Domain": "ai",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "intent_recognition_system",
        "domain": "ai",
        "resource_tier": "large",
        "port": 8140,
        "harmony_target": 0.997,
