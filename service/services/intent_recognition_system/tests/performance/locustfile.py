"""Performance tests for intent_recognition_system.
Port: 8140 | Rate limit: 1000 rpm
...
class IntentRecognitionSystemUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/intent_recognition_system/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/intent_recognition_system/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.post("/api/intent_recognition_system/ai/process",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/intent_recognition_system/health")
