"""User Story Acceptance Tests — intent_recognition_system
US: US-410..US-0683 (90 stories) | Port: 8140 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/intent_recognition_system"
SERVICE_PORT  = 8140


class TestIntentRecognitionSystemUserStories:
