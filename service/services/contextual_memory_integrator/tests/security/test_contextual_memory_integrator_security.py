"""Security tests for contextual_memory_integrator.
Port: 8232 | Encryption: advanced | Audit retention: 365 days
OWASP Top 10 — Plan 123 Phase 3 (7 security tests).
Variables from CENTRAL_VARIABLE_REGISTRY.
"""
import pytest, httpx

SERVICE_BASE  = "http://151.145.202.116:30671/api/contextual_memory_integrator"
SERVICE_PORT  = 8232
ENC_LEVEL     = "advanced"


class TestContextualMemoryIntegratorSecurity:
