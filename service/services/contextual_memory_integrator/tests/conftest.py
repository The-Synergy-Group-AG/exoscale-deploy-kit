"""Shared test fixtures for contextual_memory_integrator.
Domain: ai | Port: 8232 | NS: jtp
...
SERVICE_NAME   = "contextual_memory_integrator"
SERVICE_PORT   = 8232
...
def service_name():
    return "contextual_memory_integrator"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/contextual_memory_integrator"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-contextual_memory_integrator",
        "X-Service-Name": "contextual_memory_integrator",
        "X-Domain": "ai",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "contextual_memory_integrator",
        "domain": "ai",
        "resource_tier": "large",
        "port": 8232,
        "harmony_target": 0.997,
