"""Performance tests for network_security_gateway.
Port: 8245 | Rate limit: 1000 rpm
...
class NetworkSecurityGatewayUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/network_security_gateway/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/network_security_gateway/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/network_security_gateway/security/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/network_security_gateway/health")
