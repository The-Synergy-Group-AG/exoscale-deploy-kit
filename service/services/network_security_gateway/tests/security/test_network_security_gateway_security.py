"""Security tests for network_security_gateway.
Port: 8245 | Encryption: advanced | Audit retention: 365 days
OWASP Top 10 — Plan 123 Phase 3 (7 security tests).
Variables from CENTRAL_VARIABLE_REGISTRY.
"""
import pytest, httpx

SERVICE_BASE  = "http://151.145.202.116:30671/api/network_security_gateway"
SERVICE_PORT  = 8245
ENC_LEVEL     = "advanced"


class TestNetworkSecurityGatewaySecurity:
