"""Shared test fixtures for network_security_gateway.
Domain: security | Port: 8245 | NS: jtp
...
SERVICE_NAME   = "network_security_gateway"
SERVICE_PORT   = 8245
...
def service_name():
    return "network_security_gateway"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/network_security_gateway"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-network_security_gateway",
        "X-Service-Name": "network_security_gateway",
        "X-Domain": "security",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "network_security_gateway",
        "domain": "security",
        "resource_tier": "large",
        "port": 8245,
        "harmony_target": 0.997,
