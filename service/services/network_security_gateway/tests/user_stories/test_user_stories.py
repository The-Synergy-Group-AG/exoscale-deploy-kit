"""User Story Acceptance Tests — network_security_gateway
US: US-001..US-0601 (241 stories) | Port: 8245 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/network_security_gateway"
SERVICE_PORT  = 8245


class TestNetworkSecurityGatewayUserStories:
