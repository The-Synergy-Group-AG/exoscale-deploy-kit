"""Shared test fixtures for ai_ethics_enforcer_category.
Domain: ai | Port: 8233 | NS: jtp
...
SERVICE_NAME   = "ai_ethics_enforcer_category"
SERVICE_PORT   = 8233
...
def service_name():
    return "ai_ethics_enforcer_category"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/ai_ethics_enforcer_category"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-ai_ethics_enforcer_category",
        "X-Service-Name": "ai_ethics_enforcer_category",
        "X-Domain": "ai",
    }
