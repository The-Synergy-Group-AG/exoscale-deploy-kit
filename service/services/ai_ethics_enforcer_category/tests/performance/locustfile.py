"""Performance tests for ai_ethics_enforcer_category.
Port: 8233 | Rate limit: 1000 rpm
...
class AiEthicsEnforcerCategoryUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/ai_ethics_enforcer_category/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/ai_ethics_enforcer_category/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.post("/api/ai_ethics_enforcer_category/ai/process",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/ai_ethics_enforcer_category/health")
