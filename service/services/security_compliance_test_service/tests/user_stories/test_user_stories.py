"""User Story Acceptance Tests — security_compliance_test_service
US: US-357..US-0611 (55 stories) | Port: 8211 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/security_compliance_test_service"
SERVICE_PORT  = 8211


class TestSecurityComplianceTestServiceUserStories:
