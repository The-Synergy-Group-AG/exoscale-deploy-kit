"""Shared test fixtures for security_compliance_test_service.
Domain: compliance | Port: 8211 | NS: jtp
...
SERVICE_NAME   = "security_compliance_test_service"
SERVICE_PORT   = 8211
...
def service_name():
    return "security_compliance_test_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/security_compliance_test_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-security_compliance_test_service",
        "X-Service-Name": "security_compliance_test_service",
        "X-Domain": "compliance",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "security_compliance_test_service",
        "domain": "compliance",
        "resource_tier": "medium",
        "port": 8211,
        "harmony_target": 0.997,
