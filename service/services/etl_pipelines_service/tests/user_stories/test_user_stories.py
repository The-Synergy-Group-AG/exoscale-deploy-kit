"""User Story Acceptance Tests — etl_pipelines_service
US: US-001..US-0601 (241 stories) | Port: 8193 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/etl_pipelines_service"
SERVICE_PORT  = 8193


class TestEtlPipelinesServiceUserStories:
