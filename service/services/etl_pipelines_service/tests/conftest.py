"""Shared test fixtures for etl_pipelines_service.
Domain: workflow | Port: 8193 | NS: jtp
...
SERVICE_NAME   = "etl_pipelines_service"
SERVICE_PORT   = 8193
...
def service_base(gateway_url):
    return f"{gateway_url}/api/etl_pipelines_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-etl_pipelines_service",
        "X-Service-Name": "etl_pipelines_service",
        "X-Domain": "workflow",
    }
