"""Performance tests for networking-frontend.
Port: 8133 | Rate limit: 1000 rpm
...
class NetworkingFrontendUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/networking-frontend/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/networking-frontend/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/networking-frontend/api/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/networking-frontend/health")
