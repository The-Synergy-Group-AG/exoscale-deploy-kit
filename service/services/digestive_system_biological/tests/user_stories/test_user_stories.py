"""User Story Acceptance Tests — digestive_system_biological
US: US-143..US-279 (115 stories) | Port: 8230 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/digestive_system_biological"
SERVICE_PORT  = 8230


class TestDigestiveSystemBiologicalUserStories:
