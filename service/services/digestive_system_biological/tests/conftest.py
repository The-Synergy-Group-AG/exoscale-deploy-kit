"""Shared test fixtures for digestive_system_biological.
Domain: biological | Port: 8230 | NS: jtp
...
SERVICE_NAME   = "digestive_system_biological"
SERVICE_PORT   = 8230
...
def service_name():
    return "digestive_system_biological"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/digestive_system_biological"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-digestive_system_biological",
        "X-Service-Name": "digestive_system_biological",
        "X-Domain": "biological",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "digestive_system_biological",
        "domain": "biological",
        "resource_tier": "large",
        "port": 8230,
        "harmony_target": 0.997,
