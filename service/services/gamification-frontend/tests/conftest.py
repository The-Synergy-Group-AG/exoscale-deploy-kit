"""Shared test fixtures for gamification-frontend.
Domain: frontend | Port: 8156 | NS: jtp
...
SERVICE_NAME   = "gamification-frontend"
SERVICE_PORT   = 8156
...
def service_base(gateway_url):
    return f"{gateway_url}/api/gamification-frontend"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-gamification-frontend",
        "X-Service-Name": "gamification-frontend",
        "X-Domain": "frontend",
    }
