"""Shared test fixtures for genetic_biological_processor.
Domain: authentication | Port: 8237 | NS: jtp
...
SERVICE_NAME   = "genetic_biological_processor"
SERVICE_PORT   = 8237
...
def service_name():
    return "genetic_biological_processor"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/genetic_biological_processor"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-genetic_biological_processor",
        "X-Service-Name": "genetic_biological_processor",
...
def expected_service_meta():
    ...
    return {
        "service": "genetic_biological_processor",
