"""Security tests for genetic_biological_processor.
Port: 8237 | Encryption: advanced | Audit retention: 365 days
OWASP Top 10 — Plan 123 Phase 3 (7 security tests).
Variables from CENTRAL_VARIABLE_REGISTRY.
"""
import pytest, httpx

SERVICE_BASE  = "http://151.145.202.116:30671/api/genetic_biological_processor"
SERVICE_PORT  = 8237
ENC_LEVEL     = "advanced"


class TestGeneticBiologicalProcessorSecurity:
