"""Performance tests for genetic_biological_processor.
Port: 8237 | Rate limit: 1000 rpm
...
class GeneticBiologicalProcessorUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/genetic_biological_processor/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/genetic_biological_processor/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/genetic_biological_processor/auth/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/genetic_biological_processor/health")
