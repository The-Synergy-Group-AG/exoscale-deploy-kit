"""Performance tests for vector_store.
Port: 8113 | Rate limit: 1000 rpm
...
class VectorStoreUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/vector_store/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/vector_store/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.post("/api/vector_store/ai/process",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/vector_store/health")
