"""Shared test fixtures for vector_store.
Domain: ai | Port: 8113 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/vector_store"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-vector_store",
        "X-Service-Name": "vector_store",
        "X-Domain": "ai",
    }
