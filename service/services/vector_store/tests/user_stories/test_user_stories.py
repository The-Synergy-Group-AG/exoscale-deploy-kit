"""User Story Acceptance Tests — vector_store
US: US-410..US-0683 (90 stories) | Port: 8113 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/vector_store"
SERVICE_PORT  = 8113


class TestVectorStoreUserStories:
