"""Shared test fixtures for docker_orchestration.
Domain: workflow | Port: 8174 | NS: jtp
...
SERVICE_NAME   = "docker_orchestration"
SERVICE_PORT   = 8174
...
def service_base(gateway_url):
    return f"{gateway_url}/api/docker_orchestration"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-docker_orchestration",
        "X-Service-Name": "docker_orchestration",
        "X-Domain": "workflow",
    }
