"""Performance tests for docker_orchestration.
Port: 8174 | Rate limit: 1000 rpm
...
class DockerOrchestrationUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/docker_orchestration/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/docker_orchestration/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/docker_orchestration/workflows",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/docker_orchestration/health")
