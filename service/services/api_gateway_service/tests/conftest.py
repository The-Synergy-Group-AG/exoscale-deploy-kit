"""Shared test fixtures for api_gateway_service.
Domain: security | Port: 8015 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/api_gateway_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-api_gateway_service",
        "X-Service-Name": "api_gateway_service",
        "X-Domain": "security",
    }
