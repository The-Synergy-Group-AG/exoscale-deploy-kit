"""User Story Acceptance Tests — api_gateway_service
US: US-001..US-0601 (241 stories) | Port: 8015 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/api_gateway_service"
SERVICE_PORT  = 8015


class TestApiGatewayServiceUserStories:
