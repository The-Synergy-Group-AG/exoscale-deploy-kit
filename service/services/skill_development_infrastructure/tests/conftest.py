"""Shared test fixtures for skill_development_infrastructure.
Domain: career | Port: 8240 | NS: jtp
...
SERVICE_NAME   = "skill_development_infrastructure"
SERVICE_PORT   = 8240
...
def service_name():
    return "skill_development_infrastructure"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/skill_development_infrastructure"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-skill_development_infrastructure",
        "X-Service-Name": "skill_development_infrastructure",
        "X-Domain": "career",
    }
