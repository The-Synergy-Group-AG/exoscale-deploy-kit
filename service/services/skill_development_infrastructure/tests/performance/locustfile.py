"""Performance tests for skill_development_infrastructure.
Port: 8240 | Rate limit: 1000 rpm
...
class SkillDevelopmentInfrastructureUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/skill_development_infrastructure/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/skill_development_infrastructure/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/skill_development_infrastructure/jobs",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/skill_development_infrastructure/health")
