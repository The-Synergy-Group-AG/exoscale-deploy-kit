"""User Story Acceptance Tests — skill_development_infrastructure
US: US-280..US-323 (28 stories) | Port: 8240 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/skill_development_infrastructure"
SERVICE_PORT  = 8240


class TestSkillDevelopmentInfrastructureUserStories:
