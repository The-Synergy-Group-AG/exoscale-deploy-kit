"""Shared test fixtures for natural_language_processor_category.
Domain: authentication | Port: 8107 | NS: jtp
...
SERVICE_NAME   = "natural_language_processor_category"
SERVICE_PORT   = 8107
...
def service_name():
    return "natural_language_processor_category"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/natural_language_processor_category"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-natural_language_processor_category",
        "X-Service-Name": "natural_language_processor_category",
...
def expected_service_meta():
    ...
    return {
        "service": "natural_language_processor_category",
