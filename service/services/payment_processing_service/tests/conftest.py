"""Shared test fixtures for payment_processing_service.
Domain: payment | Port: 8290 | NS: jtp
...
def service_name():
    return "payment_processing_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/payment_processing_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-payment_processing_service",
        "X-Service-Name": "payment_processing_service",
        "X-Domain": "payment",
    }
