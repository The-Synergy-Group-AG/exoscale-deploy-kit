"""Performance tests for payment_processing_service.
Port: 8290 | Rate limit: 1000 rpm
...
class PaymentProcessingServiceUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/payment_processing_service/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/payment_processing_service/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/payment_processing_service/payments",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/payment_processing_service/health")
