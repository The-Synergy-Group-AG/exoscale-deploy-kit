"""Shared test fixtures for cellular_communication_network_bulk.
Domain: biological | Port: 8221 | NS: jtp
...
SERVICE_NAME   = "cellular_communication_network_bulk"
SERVICE_PORT   = 8221
...
def service_name():
    return "cellular_communication_network_bulk"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/cellular_communication_network_bulk"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-cellular_communication_network_bulk",
        "X-Service-Name": "cellular_communication_network_bulk",
        "X-Domain": "biological",
    }
