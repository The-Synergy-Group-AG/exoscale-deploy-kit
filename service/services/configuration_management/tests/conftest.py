"""Shared test fixtures for configuration_management.
Domain: configuration | Port: 8118 | NS: jtp
...
SERVICE_NAME   = "configuration_management"
SERVICE_PORT   = 8118
...
def service_base(gateway_url):
    return f"{gateway_url}/api/configuration_management"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-configuration_management",
        "X-Service-Name": "configuration_management",
