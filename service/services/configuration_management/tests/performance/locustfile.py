"""Performance tests for configuration_management.
Port: 8118 | Rate limit: 1000 rpm
...
class ConfigurationManagementUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/configuration_management/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/configuration_management/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/configuration_management/config",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/configuration_management/health")
