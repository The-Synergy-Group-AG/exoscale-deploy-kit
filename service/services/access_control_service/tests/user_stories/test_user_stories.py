"""User Story Acceptance Tests — access_control_service
US: US-001..US-0601 (241 stories) | Port: 8251 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/access_control_service"
SERVICE_PORT  = 8251


class TestAccessControlServiceUserStories:
