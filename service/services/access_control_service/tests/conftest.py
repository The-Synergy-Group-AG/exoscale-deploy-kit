"""Shared test fixtures for access_control_service.
Domain: security | Port: 8251 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/access_control_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-access_control_service",
        "X-Service-Name": "access_control_service",
        "X-Domain": "security",
    }
