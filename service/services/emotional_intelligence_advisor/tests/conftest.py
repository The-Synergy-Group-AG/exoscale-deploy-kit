"""Shared test fixtures for emotional_intelligence_advisor.
Domain: ai | Port: 8179 | NS: jtp
...
SERVICE_NAME   = "emotional_intelligence_advisor"
SERVICE_PORT   = 8179
...
def service_name():
    return "emotional_intelligence_advisor"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/emotional_intelligence_advisor"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-emotional_intelligence_advisor",
        "X-Service-Name": "emotional_intelligence_advisor",
        "X-Domain": "ai",
    }
