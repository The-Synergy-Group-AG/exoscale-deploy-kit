"""User Story Acceptance Tests — performance_optimizer_category
US: US-097..US-0630 (89 stories) | Port: 8129 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/performance_optimizer_category"
SERVICE_PORT  = 8129


class TestPerformanceOptimizerCategoryUserStories:
