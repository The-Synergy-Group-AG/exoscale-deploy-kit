"""Shared test fixtures for performance_optimizer_category.
Domain: monitoring | Port: 8129 | NS: jtp
...
SERVICE_NAME   = "performance_optimizer_category"
SERVICE_PORT   = 8129
...
def service_name():
    return "performance_optimizer_category"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/performance_optimizer_category"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-performance_optimizer_category",
        "X-Service-Name": "performance_optimizer_category",
        "X-Domain": "monitoring",
    }
