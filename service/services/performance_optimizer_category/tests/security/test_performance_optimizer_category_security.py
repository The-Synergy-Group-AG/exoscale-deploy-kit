"""Security tests for performance_optimizer_category.
Port: 8129 | Encryption: advanced | Audit retention: 365 days
OWASP Top 10 — Plan 123 Phase 3 (7 security tests).
Variables from CENTRAL_VARIABLE_REGISTRY.
"""
import pytest, httpx

SERVICE_BASE  = "http://151.145.202.116:30671/api/performance_optimizer_category"
SERVICE_PORT  = 8129
ENC_LEVEL     = "advanced"


class TestPerformanceOptimizerCategorySecurity:
