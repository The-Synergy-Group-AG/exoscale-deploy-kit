"""Shared test fixtures for neural_consciousness_amplifier.
Domain: ai | Port: 8155 | NS: jtp
...
SERVICE_NAME   = "neural_consciousness_amplifier"
SERVICE_PORT   = 8155
...
def service_name():
    return "neural_consciousness_amplifier"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/neural_consciousness_amplifier"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-neural_consciousness_amplifier",
        "X-Service-Name": "neural_consciousness_amplifier",
        "X-Domain": "ai",
    }
