"""Performance tests for advanced_analytics_bi_service.
Port: 8164 | Rate limit: 1000 rpm
...
class AdvancedAnalyticsBiServiceUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/advanced_analytics_bi_service/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/advanced_analytics_bi_service/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/advanced_analytics_bi_service/analytics/dashboard",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/advanced_analytics_bi_service/health")
