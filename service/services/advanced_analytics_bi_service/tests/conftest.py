"""Shared test fixtures for advanced_analytics_bi_service.
Domain: analytics | Port: 8164 | NS: jtp
...
SERVICE_NAME   = "advanced_analytics_bi_service"
SERVICE_PORT   = 8164
...
def service_name():
    return "advanced_analytics_bi_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/advanced_analytics_bi_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-advanced_analytics_bi_service",
        "X-Service-Name": "advanced_analytics_bi_service",
        "X-Domain": "analytics",
    }
