"""Shared test fixtures for notification_service.
Domain: notification | Port: 8260 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/notification_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-notification_service",
        "X-Service-Name": "notification_service",
