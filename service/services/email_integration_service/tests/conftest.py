"""Shared test fixtures for email_integration_service.
Domain: notification | Port: 8154 | NS: jtp
...
SERVICE_NAME   = "email_integration_service"
SERVICE_PORT   = 8154
...
def service_name():
    return "email_integration_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/email_integration_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-email_integration_service",
        "X-Service-Name": "email_integration_service",
...
def expected_service_meta():
    ...
    return {
        "service": "email_integration_service",
        "domain": "notification",
        "resource_tier": "small",
        "port": 8154,
        "harmony_target": 0.997,
