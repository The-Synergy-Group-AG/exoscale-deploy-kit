"""Performance tests for test_messaging_queue_validation.
Port: 8301 | Rate limit: 1000 rpm
...
class TestMessagingQueueValidationUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/test_messaging_queue_validation/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/test_messaging_queue_validation/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/test_messaging_queue_validation/notifications",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/test_messaging_queue_validation/health")
