"""Shared test fixtures for test_messaging_queue_validation.
Domain: notification | Port: 8301 | NS: jtp
...
SERVICE_NAME   = "test_messaging_queue_validation"
SERVICE_PORT   = 8301
GATEWAY_URL    = "http://151.145.202.116:30671"
SERVICE_DOMAIN = "notification"
...
def service_name():
    return "test_messaging_queue_validation"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/test_messaging_queue_validation"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-test_messaging_queue_validation",
        "X-Service-Name": "test_messaging_queue_validation",
...
def expected_service_meta():
    ...
    return {
        "service": "test_messaging_queue_validation",
        "domain": "notification",
        "resource_tier": "small",
        "port": 8301,
        "harmony_target": 0.997,
