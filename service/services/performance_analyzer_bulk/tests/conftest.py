"""Shared test fixtures for performance_analyzer_bulk.
Domain: monitoring | Port: 8296 | NS: jtp
...
SERVICE_NAME   = "performance_analyzer_bulk"
SERVICE_PORT   = 8296
...
def service_name():
    return "performance_analyzer_bulk"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/performance_analyzer_bulk"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-performance_analyzer_bulk",
        "X-Service-Name": "performance_analyzer_bulk",
        "X-Domain": "monitoring",
    }
