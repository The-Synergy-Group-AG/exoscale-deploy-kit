"""Performance tests for performance_analyzer_bulk.
Port: 8296 | Rate limit: 1000 rpm
...
class PerformanceAnalyzerBulkUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/performance_analyzer_bulk/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/performance_analyzer_bulk/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/performance_analyzer_bulk/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/performance_analyzer_bulk/health")
