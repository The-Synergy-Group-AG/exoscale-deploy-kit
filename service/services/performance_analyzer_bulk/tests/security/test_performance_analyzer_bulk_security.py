"""Security tests for performance_analyzer_bulk.
Port: 8296 | Encryption: advanced | Audit retention: 365 days
OWASP Top 10 — Plan 123 Phase 3 (7 security tests).
Variables from CENTRAL_VARIABLE_REGISTRY.
"""
import pytest, httpx

SERVICE_BASE  = "http://151.145.202.116:30671/api/performance_analyzer_bulk"
SERVICE_PORT  = 8296
ENC_LEVEL     = "advanced"


class TestPerformanceAnalyzerBulkSecurity:
