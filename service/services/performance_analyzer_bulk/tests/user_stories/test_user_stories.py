"""User Story Acceptance Tests — performance_analyzer_bulk
US: US-097..US-0630 (89 stories) | Port: 8296 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/performance_analyzer_bulk"
SERVICE_PORT  = 8296


class TestPerformanceAnalyzerBulkUserStories:
