"""Performance tests for security_monitoring_system.
Port: 8203 | Rate limit: 1000 rpm
...
class SecurityMonitoringSystemUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/security_monitoring_system/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/security_monitoring_system/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/security_monitoring_system/security/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/security_monitoring_system/health")
