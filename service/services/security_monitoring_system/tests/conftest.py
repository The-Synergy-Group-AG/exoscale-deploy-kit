"""Shared test fixtures for security_monitoring_system.
Domain: security | Port: 8203 | NS: jtp
...
SERVICE_NAME   = "security_monitoring_system"
SERVICE_PORT   = 8203
...
def service_base(gateway_url):
    return f"{gateway_url}/api/security_monitoring_system"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-security_monitoring_system",
        "X-Service-Name": "security_monitoring_system",
        "X-Domain": "security",
    }
