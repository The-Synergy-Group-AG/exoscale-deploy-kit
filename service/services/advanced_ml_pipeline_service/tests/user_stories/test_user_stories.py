"""User Story Acceptance Tests — advanced_ml_pipeline_service
US: US-410..US-0683 (90 stories) | Port: 8115 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/advanced_ml_pipeline_service"
SERVICE_PORT  = 8115


class TestAdvancedMlPipelineServiceUserStories:
