"""Shared test fixtures for advanced_ml_pipeline_service.
Domain: ai | Port: 8115 | NS: jtp
...
SERVICE_NAME   = "advanced_ml_pipeline_service"
SERVICE_PORT   = 8115
...
def service_name():
    return "advanced_ml_pipeline_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/advanced_ml_pipeline_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-advanced_ml_pipeline_service",
        "X-Service-Name": "advanced_ml_pipeline_service",
        "X-Domain": "ai",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "advanced_ml_pipeline_service",
        "domain": "ai",
        "resource_tier": "large",
        "port": 8115,
        "harmony_target": 0.997,
