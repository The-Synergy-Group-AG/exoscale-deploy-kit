"""Shared test fixtures for document_management_service.
Domain: document | Port: 8246 | NS: jtp
...
SERVICE_NAME   = "document_management_service"
SERVICE_PORT   = 8246
...
def service_base(gateway_url):
    return f"{gateway_url}/api/document_management_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-document_management_service",
        "X-Service-Name": "document_management_service",
        "X-Domain": "document",
    }
