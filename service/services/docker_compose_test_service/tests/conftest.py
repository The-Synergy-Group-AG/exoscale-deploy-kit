"""Shared test fixtures for docker_compose_test_service.
Domain: monitoring | Port: 8130 | NS: jtp
...
SERVICE_NAME   = "docker_compose_test_service"
SERVICE_PORT   = 8130
...
def service_name():
    return "docker_compose_test_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/docker_compose_test_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-docker_compose_test_service",
        "X-Service-Name": "docker_compose_test_service",
        "X-Domain": "monitoring",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "docker_compose_test_service",
        "domain": "monitoring",
        "resource_tier": "small",
        "port": 8130,
        "harmony_target": 0.997,
