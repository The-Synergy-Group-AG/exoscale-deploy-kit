"""User Story Acceptance Tests — docker_compose_test_service
US: US-097..US-0630 (89 stories) | Port: 8130 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/docker_compose_test_service"
SERVICE_PORT  = 8130


class TestDockerComposeTestServiceUserStories:
