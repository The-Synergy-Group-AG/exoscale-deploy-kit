"""Shared test fixtures for consciousness_service.
Domain: biological | Port: 8235 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/consciousness_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-consciousness_service",
        "X-Service-Name": "consciousness_service",
        "X-Domain": "biological",
    }
