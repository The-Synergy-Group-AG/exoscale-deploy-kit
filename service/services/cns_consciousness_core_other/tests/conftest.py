"""Shared test fixtures for cns_consciousness_core_other.
Domain: biological | Port: 8216 | NS: jtp
...
SERVICE_NAME   = "cns_consciousness_core_other"
SERVICE_PORT   = 8216
...
def service_name():
    return "cns_consciousness_core_other"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/cns_consciousness_core_other"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-cns_consciousness_core_other",
        "X-Service-Name": "cns_consciousness_core_other",
        "X-Domain": "biological",
    }
