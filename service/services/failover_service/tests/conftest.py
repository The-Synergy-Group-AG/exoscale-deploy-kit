"""Shared test fixtures for failover_service.
Domain: backup | Port: 8194 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/failover_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-failover_service",
        "X-Service-Name": "failover_service",
        "X-Domain": "backup",
    }
