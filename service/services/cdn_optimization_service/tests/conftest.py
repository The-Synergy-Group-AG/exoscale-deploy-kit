"""Shared test fixtures for cdn_optimization_service.
Domain: workflow | Port: 8303 | NS: jtp
...
SERVICE_NAME   = "cdn_optimization_service"
SERVICE_PORT   = 8303
...
def service_name():
    return "cdn_optimization_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/cdn_optimization_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-cdn_optimization_service",
        "X-Service-Name": "cdn_optimization_service",
        "X-Domain": "workflow",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "cdn_optimization_service",
        "domain": "workflow",
        "resource_tier": "medium",
        "port": 8303,
        "harmony_target": 0.997,
