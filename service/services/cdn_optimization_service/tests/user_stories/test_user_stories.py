"""User Story Acceptance Tests — cdn_optimization_service
US: US-001..US-0601 (241 stories) | Port: 8303 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/cdn_optimization_service"
SERVICE_PORT  = 8303


class TestCdnOptimizationServiceUserStories:
