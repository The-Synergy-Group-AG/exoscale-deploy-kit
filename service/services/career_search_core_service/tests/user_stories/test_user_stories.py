"""User Story Acceptance Tests — career_search_core_service
US: US-280..US-323 (28 stories) | Port: 8262 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/career_search_core_service"
SERVICE_PORT  = 8262


class TestCareerSearchCoreServiceUserStories:
