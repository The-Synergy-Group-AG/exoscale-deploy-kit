"""Shared test fixtures for career_search_core_service.
Domain: career | Port: 8262 | NS: jtp
...
SERVICE_NAME   = "career_search_core_service"
SERVICE_PORT   = 8262
...
def service_name():
    return "career_search_core_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/career_search_core_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-career_search_core_service",
        "X-Service-Name": "career_search_core_service",
        "X-Domain": "career",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "career_search_core_service",
        "domain": "career",
        "resource_tier": "medium",
        "port": 8262,
        "harmony_target": 0.997,
