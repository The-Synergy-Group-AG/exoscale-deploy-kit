"""User Story Acceptance Tests — environment_provisioning_test_service
US: US-097..US-0630 (89 stories) | Port: 8269 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/environment_provisioning_test_service"
SERVICE_PORT  = 8269


class TestEnvironmentProvisioningTestServiceUserStories:
