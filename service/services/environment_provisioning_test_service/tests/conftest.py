"""Shared test fixtures for environment_provisioning_test_service.
Domain: monitoring | Port: 8269 | NS: jtp
...
SERVICE_NAME   = "environment_provisioning_test_service"
SERVICE_PORT   = 8269
...
def service_name():
    return "environment_provisioning_test_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/environment_provisioning_test_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-environment_provisioning_test_service",
        "X-Service-Name": "environment_provisioning_test_service",
        "X-Domain": "monitoring",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "environment_provisioning_test_service",
        "domain": "monitoring",
        "resource_tier": "small",
        "port": 8269,
        "harmony_target": 0.997,
