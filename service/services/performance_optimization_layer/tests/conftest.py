"""Shared test fixtures for performance_optimization_layer.
Domain: monitoring | Port: 8207 | NS: jtp
...
SERVICE_NAME   = "performance_optimization_layer"
SERVICE_PORT   = 8207
...
def service_name():
    return "performance_optimization_layer"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/performance_optimization_layer"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-performance_optimization_layer",
        "X-Service-Name": "performance_optimization_layer",
        "X-Domain": "monitoring",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "performance_optimization_layer",
        "domain": "monitoring",
        "resource_tier": "small",
        "port": 8207,
        "harmony_target": 0.997,
