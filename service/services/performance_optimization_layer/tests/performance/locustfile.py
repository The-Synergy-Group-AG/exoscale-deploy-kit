"""Performance tests for performance_optimization_layer.
Port: 8207 | Rate limit: 1000 rpm
...
class PerformanceOptimizationLayerUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/performance_optimization_layer/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/performance_optimization_layer/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/performance_optimization_layer/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/performance_optimization_layer/health")
