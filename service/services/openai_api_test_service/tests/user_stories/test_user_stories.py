"""User Story Acceptance Tests — openai_api_test_service
US: US-097..US-0630 (89 stories) | Port: 8146 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/openai_api_test_service"
SERVICE_PORT  = 8146


class TestOpenaiApiTestServiceUserStories:
