"""Shared test fixtures for openai_api_test_service.
Domain: monitoring | Port: 8146 | NS: jtp
...
SERVICE_NAME   = "openai_api_test_service"
SERVICE_PORT   = 8146
...
def service_name():
    return "openai_api_test_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/openai_api_test_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-openai_api_test_service",
        "X-Service-Name": "openai_api_test_service",
        "X-Domain": "monitoring",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "openai_api_test_service",
        "domain": "monitoring",
        "resource_tier": "large",
        "port": 8146,
        "harmony_target": 0.997,
