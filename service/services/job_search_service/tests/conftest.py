"""Shared test fixtures for job_search_service.
Domain: career | Port: 8285 | NS: jtp
...
SERVICE_NAME   = "job_search_service"
SERVICE_PORT   = 8285
...
def service_base(gateway_url):
    return f"{gateway_url}/api/job_search_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-job_search_service",
        "X-Service-Name": "job_search_service",
        "X-Domain": "career",
    }
