"""User Story Acceptance Tests — job_search_service
US: US-280..US-323 (28 stories) | Port: 8285 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/job_search_service"
SERVICE_PORT  = 8285


class TestJobSearchServiceUserStories:
