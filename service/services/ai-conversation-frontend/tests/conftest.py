"""Shared test fixtures for ai-conversation-frontend.
Domain: frontend | Port: 8281 | NS: jtp
...
SERVICE_NAME   = "ai-conversation-frontend"
SERVICE_PORT   = 8281
...
def service_name():
    return "ai-conversation-frontend"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/ai-conversation-frontend"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-ai-conversation-frontend",
        "X-Service-Name": "ai-conversation-frontend",
        "X-Domain": "frontend",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "ai-conversation-frontend",
        "domain": "frontend",
        "resource_tier": "small",
        "port": 8281,
        "harmony_target": 0.997,
