"""User Story Acceptance Tests — ai-conversation-frontend
US: US-324..US-0622 (35 stories) | Port: 8281 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/ai-conversation-frontend"
SERVICE_PORT  = 8281


class TestAiConversationFrontendUserStories:
