"""Performance tests for infrastructure_automation.
Port: 8270 | Rate limit: 1000 rpm
...
class InfrastructureAutomationUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/infrastructure_automation/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/infrastructure_automation/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/infrastructure_automation/workflows",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/infrastructure_automation/health")
