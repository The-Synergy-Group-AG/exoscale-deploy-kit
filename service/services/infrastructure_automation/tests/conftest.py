"""Shared test fixtures for infrastructure_automation.
Domain: workflow | Port: 8270 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/infrastructure_automation"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-infrastructure_automation",
        "X-Service-Name": "infrastructure_automation",
        "X-Domain": "workflow",
    }
