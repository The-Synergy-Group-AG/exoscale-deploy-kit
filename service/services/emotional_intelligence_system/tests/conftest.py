"""Shared test fixtures for emotional_intelligence_system.
Domain: ai | Port: 8247 | NS: jtp
...
SERVICE_NAME   = "emotional_intelligence_system"
SERVICE_PORT   = 8247
...
def service_name():
    return "emotional_intelligence_system"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/emotional_intelligence_system"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-emotional_intelligence_system",
        "X-Service-Name": "emotional_intelligence_system",
        "X-Domain": "ai",
    }
