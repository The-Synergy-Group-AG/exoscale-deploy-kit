"""Performance tests for performance_optimizer.
Port: 8135 | Rate limit: 1000 rpm
...
class PerformanceOptimizerUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/performance_optimizer/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/performance_optimizer/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/performance_optimizer/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/performance_optimizer/health")
