"""User Story Acceptance Tests — performance_optimizer
US: US-097..US-0630 (89 stories) | Port: 8135 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/performance_optimizer"
SERVICE_PORT  = 8135


class TestPerformanceOptimizerUserStories:
