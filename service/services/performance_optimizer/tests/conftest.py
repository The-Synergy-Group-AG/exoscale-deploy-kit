"""Shared test fixtures for performance_optimizer.
Domain: monitoring | Port: 8135 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/performance_optimizer"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-performance_optimizer",
        "X-Service-Name": "performance_optimizer",
        "X-Domain": "monitoring",
    }
