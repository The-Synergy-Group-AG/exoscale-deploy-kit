"""User Story Acceptance Tests — portal_integration_hub
US: US-001..US-0601 (241 stories) | Port: 8273 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/portal_integration_hub"
SERVICE_PORT  = 8273


class TestPortalIntegrationHubUserStories:
