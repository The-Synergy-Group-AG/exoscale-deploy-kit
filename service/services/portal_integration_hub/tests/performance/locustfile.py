"""Performance tests for portal_integration_hub.
Port: 8273 | Rate limit: 1000 rpm
...
class PortalIntegrationHubUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/portal_integration_hub/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/portal_integration_hub/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/portal_integration_hub/workflows",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/portal_integration_hub/health")
