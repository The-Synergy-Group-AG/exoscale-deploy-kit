"""Performance tests for document_processing_ocr_service.
Port: 8167 | Rate limit: 1000 rpm
...
class DocumentProcessingOcrServiceUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/document_processing_ocr_service/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/document_processing_ocr_service/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/document_processing_ocr_service/documents",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/document_processing_ocr_service/health")
