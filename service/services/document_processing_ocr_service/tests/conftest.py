"""Shared test fixtures for document_processing_ocr_service.
Domain: document | Port: 8167 | NS: jtp
...
SERVICE_NAME   = "document_processing_ocr_service"
SERVICE_PORT   = 8167
...
def service_name():
    return "document_processing_ocr_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/document_processing_ocr_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-document_processing_ocr_service",
        "X-Service-Name": "document_processing_ocr_service",
        "X-Domain": "document",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "document_processing_ocr_service",
        "domain": "document",
        "resource_tier": "medium",
        "port": 8167,
        "harmony_target": 0.997,
