"""Performance tests for job_discovery_service.
Port: 8267 | Rate limit: 1000 rpm
...
class JobDiscoveryServiceUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/job_discovery_service/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/job_discovery_service/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/job_discovery_service/jobs",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/job_discovery_service/health")
