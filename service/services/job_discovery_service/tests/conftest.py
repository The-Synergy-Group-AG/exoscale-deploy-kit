"""Shared test fixtures for job_discovery_service.
Domain: career | Port: 8267 | NS: jtp
...
SERVICE_NAME   = "job_discovery_service"
SERVICE_PORT   = 8267
...
def service_base(gateway_url):
    return f"{gateway_url}/api/job_discovery_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-job_discovery_service",
        "X-Service-Name": "job_discovery_service",
        "X-Domain": "career",
    }
