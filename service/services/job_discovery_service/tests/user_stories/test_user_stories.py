"""User Story Acceptance Tests — job_discovery_service
US: US-280..US-323 (28 stories) | Port: 8267 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/job_discovery_service"
SERVICE_PORT  = 8267


class TestJobDiscoveryServiceUserStories:
