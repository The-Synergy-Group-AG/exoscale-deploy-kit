"""Shared test fixtures for notifications-center-frontend.
Domain: frontend | Port: 8201 | NS: jtp
...
SERVICE_NAME   = "notifications-center-frontend"
SERVICE_PORT   = 8201
...
def service_name():
    return "notifications-center-frontend"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/notifications-center-frontend"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-notifications-center-frontend",
        "X-Service-Name": "notifications-center-frontend",
        "X-Domain": "frontend",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "notifications-center-frontend",
        "domain": "frontend",
        "resource_tier": "small",
        "port": 8201,
        "harmony_target": 0.997,
