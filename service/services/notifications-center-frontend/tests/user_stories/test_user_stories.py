"""User Story Acceptance Tests — notifications-center-frontend
US: US-324..US-0622 (35 stories) | Port: 8201 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/notifications-center-frontend"
SERVICE_PORT  = 8201


class TestNotificationsCenterFrontendUserStories:
