"""Security tests for notifications-center-frontend.
Port: 8201 | Encryption: advanced | Audit retention: 365 days
OWASP Top 10 — Plan 123 Phase 3 (7 security tests).
Variables from CENTRAL_VARIABLE_REGISTRY.
"""
import pytest, httpx

SERVICE_BASE  = "http://151.145.202.116:30671/api/notifications-center-frontend"
SERVICE_PORT  = 8201
ENC_LEVEL     = "advanced"


class TestNotificationsCenterFrontendSecurity:
