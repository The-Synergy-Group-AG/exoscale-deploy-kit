"""Shared test fixtures for unified_consciousness_api.
Domain: biological | Port: 8212 | NS: jtp
...
SERVICE_NAME   = "unified_consciousness_api"
SERVICE_PORT   = 8212
...
def service_name():
    return "unified_consciousness_api"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/unified_consciousness_api"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-unified_consciousness_api",
        "X-Service-Name": "unified_consciousness_api",
        "X-Domain": "biological",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "unified_consciousness_api",
        "domain": "biological",
        "resource_tier": "large",
        "port": 8212,
        "harmony_target": 0.997,
