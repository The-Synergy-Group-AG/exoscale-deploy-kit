"""Shared test fixtures for biological_memory_system.
Domain: biological | Port: 8239 | NS: jtp
...
SERVICE_NAME   = "biological_memory_system"
SERVICE_PORT   = 8239
...
def service_name():
    return "biological_memory_system"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/biological_memory_system"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-biological_memory_system",
        "X-Service-Name": "biological_memory_system",
        "X-Domain": "biological",
    }
