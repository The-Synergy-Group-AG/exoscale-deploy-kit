"""Security tests for consciousness_validation_system_other.
Port: 8252 | Encryption: advanced | Audit retention: 365 days
OWASP Top 10 — Plan 123 Phase 3 (7 security tests).
Variables from CENTRAL_VARIABLE_REGISTRY.
"""
import pytest, httpx

SERVICE_BASE  = "http://151.145.202.116:30671/api/consciousness_validation_system_other"
SERVICE_PORT  = 8252
ENC_LEVEL     = "advanced"


class TestConsciousnessValidationSystemOtherSecurity:
