"""Shared test fixtures for consciousness_validation_system_other.
Domain: biological | Port: 8252 | NS: jtp
...
SERVICE_NAME   = "consciousness_validation_system_other"
SERVICE_PORT   = 8252
...
def service_name():
    return "consciousness_validation_system_other"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/consciousness_validation_system_other"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-consciousness_validation_system_other",
        "X-Service-Name": "consciousness_validation_system_other",
        "X-Domain": "biological",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "consciousness_validation_system_other",
        "domain": "biological",
        "resource_tier": "large",
        "port": 8252,
        "harmony_target": 0.997,
