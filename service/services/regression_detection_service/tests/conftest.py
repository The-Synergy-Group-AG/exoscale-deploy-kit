"""Shared test fixtures for regression_detection_service.
Domain: monitoring | Port: 8124 | NS: jtp
...
SERVICE_NAME   = "regression_detection_service"
SERVICE_PORT   = 8124
...
def service_name():
    return "regression_detection_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/regression_detection_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-regression_detection_service",
        "X-Service-Name": "regression_detection_service",
        "X-Domain": "monitoring",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "regression_detection_service",
        "domain": "monitoring",
        "resource_tier": "small",
        "port": 8124,
        "harmony_target": 0.997,
