"""Security tests for regression_detection_service.
Port: 8124 | Encryption: advanced | Audit retention: 365 days
OWASP Top 10 — Plan 123 Phase 3 (7 security tests).
Variables from CENTRAL_VARIABLE_REGISTRY.
"""
import pytest, httpx

SERVICE_BASE  = "http://151.145.202.116:30671/api/regression_detection_service"
SERVICE_PORT  = 8124
ENC_LEVEL     = "advanced"


class TestRegressionDetectionServiceSecurity:
