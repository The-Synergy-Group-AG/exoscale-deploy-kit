"""User Story Acceptance Tests — regression_detection_service
US: US-097..US-0630 (89 stories) | Port: 8124 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/regression_detection_service"
SERVICE_PORT  = 8124


class TestRegressionDetectionServiceUserStories:
