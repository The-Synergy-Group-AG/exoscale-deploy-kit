"""Security tests for performance_analytics_platform.
Port: 8138 | Encryption: advanced | Audit retention: 365 days
OWASP Top 10 — Plan 123 Phase 3 (7 security tests).
Variables from CENTRAL_VARIABLE_REGISTRY.
"""
import pytest, httpx

SERVICE_BASE  = "http://151.145.202.116:30671/api/performance_analytics_platform"
SERVICE_PORT  = 8138
ENC_LEVEL     = "advanced"


class TestPerformanceAnalyticsPlatformSecurity:
