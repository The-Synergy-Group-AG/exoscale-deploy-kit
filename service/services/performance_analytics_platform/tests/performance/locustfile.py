"""Performance tests for performance_analytics_platform.
Port: 8138 | Rate limit: 1000 rpm
...
class PerformanceAnalyticsPlatformUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/performance_analytics_platform/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/performance_analytics_platform/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/performance_analytics_platform/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/performance_analytics_platform/health")
