"""Shared test fixtures for performance_analytics_platform.
Domain: monitoring | Port: 8138 | NS: jtp
...
SERVICE_NAME   = "performance_analytics_platform"
SERVICE_PORT   = 8138
...
def service_name():
    return "performance_analytics_platform"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/performance_analytics_platform"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-performance_analytics_platform",
        "X-Service-Name": "performance_analytics_platform",
        "X-Domain": "monitoring",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "performance_analytics_platform",
        "domain": "monitoring",
        "resource_tier": "small",
        "port": 8138,
        "harmony_target": 0.997,
