"""Shared test fixtures for natural_language_processor_ai.
Domain: authentication | Port: 8136 | NS: jtp
...
SERVICE_NAME   = "natural_language_processor_ai"
SERVICE_PORT   = 8136
...
def service_name():
    return "natural_language_processor_ai"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/natural_language_processor_ai"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-natural_language_processor_ai",
        "X-Service-Name": "natural_language_processor_ai",
...
def expected_service_meta():
    ...
    return {
        "service": "natural_language_processor_ai",
