"""Performance tests for natural_language_processor_ai.
Port: 8136 | Rate limit: 1000 rpm
...
class NaturalLanguageProcessorAiUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/natural_language_processor_ai/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/natural_language_processor_ai/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/natural_language_processor_ai/auth/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/natural_language_processor_ai/health")
