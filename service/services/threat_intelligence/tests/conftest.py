"""Shared test fixtures for threat_intelligence.
Domain: security | Port: 8148 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/threat_intelligence"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-threat_intelligence",
        "X-Service-Name": "threat_intelligence",
        "X-Domain": "security",
    }
