"""User Story Acceptance Tests — threat_intelligence
US: US-001..US-0601 (241 stories) | Port: 8148 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/threat_intelligence"
SERVICE_PORT  = 8148


class TestThreatIntelligenceUserStories:
