"""Performance tests for threat_intelligence.
Port: 8148 | Rate limit: 1000 rpm
...
class ThreatIntelligenceUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/threat_intelligence/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/threat_intelligence/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/threat_intelligence/security/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/threat_intelligence/health")
