"""Performance tests for infrastructure_monitoring.
Port: 8210 | Rate limit: 1000 rpm
...
class InfrastructureMonitoringUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/infrastructure_monitoring/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/infrastructure_monitoring/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/infrastructure_monitoring/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/infrastructure_monitoring/health")
