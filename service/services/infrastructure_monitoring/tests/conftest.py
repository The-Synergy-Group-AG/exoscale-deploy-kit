"""Shared test fixtures for infrastructure_monitoring.
Domain: monitoring | Port: 8210 | NS: jtp
...
SERVICE_NAME   = "infrastructure_monitoring"
SERVICE_PORT   = 8210
...
def service_base(gateway_url):
    return f"{gateway_url}/api/infrastructure_monitoring"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-infrastructure_monitoring",
        "X-Service-Name": "infrastructure_monitoring",
        "X-Domain": "monitoring",
    }
