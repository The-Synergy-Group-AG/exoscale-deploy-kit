"""User Story Acceptance Tests — infrastructure_monitoring
US: US-097..US-0630 (89 stories) | Port: 8210 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/infrastructure_monitoring"
SERVICE_PORT  = 8210


class TestInfrastructureMonitoringUserStories:
