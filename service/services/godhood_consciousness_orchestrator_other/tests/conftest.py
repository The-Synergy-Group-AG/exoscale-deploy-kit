"""Shared test fixtures for godhood_consciousness_orchestrator_other.
Domain: biological | Port: 8153 | NS: jtp
...
SERVICE_NAME   = "godhood_consciousness_orchestrator_other"
SERVICE_PORT   = 8153
...
def service_name():
    return "godhood_consciousness_orchestrator_other"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/godhood_consciousness_orchestrator_other"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-godhood_consciousness_orchestrator_other",
        "X-Service-Name": "godhood_consciousness_orchestrator_other",
        "X-Domain": "biological",
    }
