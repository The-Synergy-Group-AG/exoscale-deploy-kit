"""Shared test fixtures for cdn_integration_service.
Domain: workflow | Port: 8227 | NS: jtp
...
SERVICE_NAME   = "cdn_integration_service"
SERVICE_PORT   = 8227
...
def service_name():
    return "cdn_integration_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/cdn_integration_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-cdn_integration_service",
        "X-Service-Name": "cdn_integration_service",
        "X-Domain": "workflow",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "cdn_integration_service",
        "domain": "workflow",
        "resource_tier": "medium",
        "port": 8227,
        "harmony_target": 0.997,
