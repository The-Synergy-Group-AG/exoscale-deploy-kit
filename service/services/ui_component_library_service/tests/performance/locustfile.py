"""Performance tests for ui_component_library_service.
Port: 8181 | Rate limit: 1000 rpm
...
class UiComponentLibraryServiceUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/ui_component_library_service/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/ui_component_library_service/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/ui_component_library_service/data",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/ui_component_library_service/health")
