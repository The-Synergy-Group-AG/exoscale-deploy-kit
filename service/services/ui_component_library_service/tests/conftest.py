"""Shared test fixtures for ui_component_library_service.
Domain: general | Port: 8181 | NS: jtp
...
SERVICE_NAME   = "ui_component_library_service"
SERVICE_PORT   = 8181
...
def service_name():
    return "ui_component_library_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/ui_component_library_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-ui_component_library_service",
        "X-Service-Name": "ui_component_library_service",
        "X-Domain": "general",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "ui_component_library_service",
        "domain": "general",
        "resource_tier": "small",
        "port": 8181,
        "harmony_target": 0.997,
