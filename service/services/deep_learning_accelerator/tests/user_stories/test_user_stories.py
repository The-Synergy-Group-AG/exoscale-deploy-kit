"""User Story Acceptance Tests — deep_learning_accelerator
US: US-410..US-0683 (90 stories) | Port: 8121 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/deep_learning_accelerator"
SERVICE_PORT  = 8121


class TestDeepLearningAcceleratorUserStories:
