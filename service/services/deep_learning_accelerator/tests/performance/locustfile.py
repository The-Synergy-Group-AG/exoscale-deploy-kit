"""Performance tests for deep_learning_accelerator.
Port: 8121 | Rate limit: 1000 rpm
...
class DeepLearningAcceleratorUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/deep_learning_accelerator/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/deep_learning_accelerator/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.post("/api/deep_learning_accelerator/ai/process",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/deep_learning_accelerator/health")
