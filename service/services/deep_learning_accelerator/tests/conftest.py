"""Shared test fixtures for deep_learning_accelerator.
Domain: ai | Port: 8121 | NS: jtp
...
SERVICE_NAME   = "deep_learning_accelerator"
SERVICE_PORT   = 8121
...
def service_name():
    return "deep_learning_accelerator"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/deep_learning_accelerator"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-deep_learning_accelerator",
        "X-Service-Name": "deep_learning_accelerator",
        "X-Domain": "ai",
    }
