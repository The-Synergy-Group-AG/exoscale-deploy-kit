"""User Story Acceptance Tests — cvs_service
US: US-280..US-323 (28 stories) | Port: 8208 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/cvs_service"
SERVICE_PORT  = 8208


class TestCvsServiceUserStories:
