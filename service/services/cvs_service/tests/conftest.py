"""Shared test fixtures for cvs_service.
Domain: career | Port: 8208 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/cvs_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-cvs_service",
        "X-Service-Name": "cvs_service",
        "X-Domain": "career",
    }
