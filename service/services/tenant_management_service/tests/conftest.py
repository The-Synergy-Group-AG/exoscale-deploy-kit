"""Shared test fixtures for tenant_management_service.
Domain: user_management | Port: 8218 | NS: jtp
...
SERVICE_NAME   = "tenant_management_service"
SERVICE_PORT   = 8218
...
def service_name():
    return "tenant_management_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/tenant_management_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-tenant_management_service",
        "X-Service-Name": "tenant_management_service",
...
def expected_service_meta():
    ...
    return {
        "service": "tenant_management_service",
