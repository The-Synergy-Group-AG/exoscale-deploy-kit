"""User Story Acceptance Tests — tenant_management_service
US: US-001..US-0601 (241 stories) | Port: 8218 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/tenant_management_service"
SERVICE_PORT  = 8218


class TestTenantManagementServiceUserStories:
