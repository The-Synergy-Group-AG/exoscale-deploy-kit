"""Shared test fixtures for test_session_management_validation.
Domain: monitoring | Port: 8143 | NS: jtp
...
SERVICE_NAME   = "test_session_management_validation"
SERVICE_PORT   = 8143
...
def service_name():
    return "test_session_management_validation"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/test_session_management_validation"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-test_session_management_validation",
        "X-Service-Name": "test_session_management_validation",
        "X-Domain": "monitoring",
    }
