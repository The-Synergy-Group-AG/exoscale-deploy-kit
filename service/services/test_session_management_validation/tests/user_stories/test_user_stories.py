"""User Story Acceptance Tests — test_session_management_validation
US: US-097..US-0630 (89 stories) | Port: 8143 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/test_session_management_validation"
SERVICE_PORT  = 8143


class TestTestSessionManagementValidationUserStories:
