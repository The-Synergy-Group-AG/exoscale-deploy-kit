"""Performance tests for consciousness_ai_bridge_ai.
Port: 8150 | Rate limit: 1000 rpm
...
class ConsciousnessAiBridgeAiUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/consciousness_ai_bridge_ai/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/consciousness_ai_bridge_ai/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.post("/api/consciousness_ai_bridge_ai/ai/process",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/consciousness_ai_bridge_ai/health")
