"""Shared test fixtures for consciousness_ai_bridge_ai.
Domain: ai | Port: 8150 | NS: jtp
...
SERVICE_NAME   = "consciousness_ai_bridge_ai"
SERVICE_PORT   = 8150
...
def service_name():
    return "consciousness_ai_bridge_ai"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/consciousness_ai_bridge_ai"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-consciousness_ai_bridge_ai",
        "X-Service-Name": "consciousness_ai_bridge_ai",
        "X-Domain": "ai",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "consciousness_ai_bridge_ai",
        "domain": "ai",
        "resource_tier": "large",
        "port": 8150,
        "harmony_target": 0.997,
