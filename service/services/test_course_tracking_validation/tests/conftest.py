"""Shared test fixtures for test_course_tracking_validation.
Domain: monitoring | Port: 8254 | NS: jtp
...
SERVICE_NAME   = "test_course_tracking_validation"
SERVICE_PORT   = 8254
...
def service_name():
    return "test_course_tracking_validation"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/test_course_tracking_validation"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-test_course_tracking_validation",
        "X-Service-Name": "test_course_tracking_validation",
        "X-Domain": "monitoring",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "test_course_tracking_validation",
        "domain": "monitoring",
        "resource_tier": "small",
        "port": 8254,
        "harmony_target": 0.997,
