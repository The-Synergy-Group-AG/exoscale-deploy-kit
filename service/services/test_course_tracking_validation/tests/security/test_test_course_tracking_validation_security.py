"""Security tests for test_course_tracking_validation.
Port: 8254 | Encryption: advanced | Audit retention: 365 days
OWASP Top 10 — Plan 123 Phase 3 (7 security tests).
Variables from CENTRAL_VARIABLE_REGISTRY.
"""
import pytest, httpx

SERVICE_BASE  = "http://151.145.202.116:30671/api/test_course_tracking_validation"
SERVICE_PORT  = 8254
ENC_LEVEL     = "advanced"


class TestTestCourseTrackingValidationSecurity:
