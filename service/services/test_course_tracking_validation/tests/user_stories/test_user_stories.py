"""User Story Acceptance Tests — test_course_tracking_validation
US: US-097..US-0630 (89 stories) | Port: 8254 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/test_course_tracking_validation"
SERVICE_PORT  = 8254


class TestTestCourseTrackingValidationUserStories:
