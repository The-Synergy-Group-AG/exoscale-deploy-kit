"""Performance tests for interview_intelligence_system.
Port: 8196 | Rate limit: 1000 rpm
...
class InterviewIntelligenceSystemUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/interview_intelligence_system/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/interview_intelligence_system/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/interview_intelligence_system/jobs",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/interview_intelligence_system/health")
