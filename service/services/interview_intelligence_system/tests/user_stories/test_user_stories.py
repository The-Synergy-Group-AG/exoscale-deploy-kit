"""User Story Acceptance Tests — interview_intelligence_system
US: US-280..US-323 (28 stories) | Port: 8196 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/interview_intelligence_system"
SERVICE_PORT  = 8196


class TestInterviewIntelligenceSystemUserStories:
