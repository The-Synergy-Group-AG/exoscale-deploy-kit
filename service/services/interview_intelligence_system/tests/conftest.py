"""Shared test fixtures for interview_intelligence_system.
Domain: career | Port: 8196 | NS: jtp
...
SERVICE_NAME   = "interview_intelligence_system"
SERVICE_PORT   = 8196
...
def service_name():
    return "interview_intelligence_system"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/interview_intelligence_system"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-interview_intelligence_system",
        "X-Service-Name": "interview_intelligence_system",
        "X-Domain": "career",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "interview_intelligence_system",
        "domain": "career",
        "resource_tier": "medium",
        "port": 8196,
        "harmony_target": 0.997,
