"""Shared test fixtures for biological_energy_distribution_category.
Domain: biological | Port: 8116 | NS: jtp
...
SERVICE_NAME   = "biological_energy_distribution_category"
SERVICE_PORT   = 8116
...
def service_name():
    return "biological_energy_distribution_category"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/biological_energy_distribution_category"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-biological_energy_distribution_category",
        "X-Service-Name": "biological_energy_distribution_category",
        "X-Domain": "biological",
    }
