"""Shared test fixtures for test_execution_metrics_service.
Domain: monitoring | Port: 8099 | NS: jtp
...
SERVICE_NAME   = "test_execution_metrics_service"
SERVICE_PORT   = 8099
...
def service_name():
    return "test_execution_metrics_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/test_execution_metrics_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-test_execution_metrics_service",
        "X-Service-Name": "test_execution_metrics_service",
        "X-Domain": "monitoring",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "test_execution_metrics_service",
        "domain": "monitoring",
        "resource_tier": "small",
        "port": 8099,
        "harmony_target": 0.997,
