"""User Story Acceptance Tests — test_execution_metrics_service
US: US-097..US-0630 (89 stories) | Port: 8099 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/test_execution_metrics_service"
SERVICE_PORT  = 8099


class TestTestExecutionMetricsServiceUserStories:
