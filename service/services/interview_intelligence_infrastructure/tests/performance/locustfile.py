"""Performance tests for interview_intelligence_infrastructure.
Port: 8242 | Rate limit: 1000 rpm
...
class InterviewIntelligenceInfrastructureUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/interview_intelligence_infrastructure/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/interview_intelligence_infrastructure/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/interview_intelligence_infrastructure/jobs",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/interview_intelligence_infrastructure/health")
