"""User Story Acceptance Tests — interview_intelligence_infrastructure
US: US-280..US-323 (28 stories) | Port: 8242 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/interview_intelligence_infrastructure"
SERVICE_PORT  = 8242


class TestInterviewIntelligenceInfrastructureUserStories:
