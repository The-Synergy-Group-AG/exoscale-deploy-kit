"""Shared test fixtures for interview_intelligence_infrastructure.
Domain: career | Port: 8242 | NS: jtp
...
SERVICE_NAME   = "interview_intelligence_infrastructure"
SERVICE_PORT   = 8242
GATEWAY_URL    = "http://151.145.202.116:30671"
SERVICE_DOMAIN = "career"
...
def service_name():
    return "interview_intelligence_infrastructure"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/interview_intelligence_infrastructure"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-interview_intelligence_infrastructure",
        "X-Service-Name": "interview_intelligence_infrastructure",
        "X-Domain": "career",
    }
