"""Performance tests for integration_bridges_system.
Port: 8186 | Rate limit: 1000 rpm
...
class IntegrationBridgesSystemUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/integration_bridges_system/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/integration_bridges_system/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/integration_bridges_system/workflows",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/integration_bridges_system/health")
