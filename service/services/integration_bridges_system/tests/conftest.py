"""Shared test fixtures for integration_bridges_system.
Domain: workflow | Port: 8186 | NS: jtp
...
SERVICE_NAME   = "integration_bridges_system"
SERVICE_PORT   = 8186
...
def service_name():
    return "integration_bridges_system"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/integration_bridges_system"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-integration_bridges_system",
        "X-Service-Name": "integration_bridges_system",
        "X-Domain": "workflow",
    }
