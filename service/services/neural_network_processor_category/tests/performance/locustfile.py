"""Performance tests for neural_network_processor_category.
Port: 8291 | Rate limit: 1000 rpm
...
class NeuralNetworkProcessorCategoryUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/neural_network_processor_category/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/neural_network_processor_category/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/neural_network_processor_category/auth/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/neural_network_processor_category/health")
