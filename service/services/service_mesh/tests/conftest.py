"""Shared test fixtures for service_mesh.
Domain: workflow | Port: 8243 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/service_mesh"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-service_mesh",
        "X-Service-Name": "service_mesh",
        "X-Domain": "workflow",
    }
