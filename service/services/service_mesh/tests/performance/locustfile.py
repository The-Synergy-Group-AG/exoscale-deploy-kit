"""Performance tests for service_mesh.
Port: 8243 | Rate limit: 1000 rpm
...
class ServiceMeshUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/service_mesh/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/service_mesh/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/service_mesh/workflows",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/service_mesh/health")
