"""Shared test fixtures for gamification_engine_service.
Domain: gamification | Port: 8263 | NS: jtp
...
SERVICE_NAME   = "gamification_engine_service"
SERVICE_PORT   = 8263
...
def service_name():
    return "gamification_engine_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/gamification_engine_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-gamification_engine_service",
        "X-Service-Name": "gamification_engine_service",
