"""Performance tests for gamification_engine_service.
Port: 8263 | Rate limit: 1000 rpm
...
class GamificationEngineServiceUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/gamification_engine_service/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/gamification_engine_service/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/gamification_engine_service/leaderboard",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/gamification_engine_service/health")
