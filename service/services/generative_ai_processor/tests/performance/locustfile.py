"""Performance tests for generative_ai_processor.
Port: 8261 | Rate limit: 1000 rpm
...
class GenerativeAiProcessorUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/generative_ai_processor/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/generative_ai_processor/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/generative_ai_processor/auth/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/generative_ai_processor/health")
