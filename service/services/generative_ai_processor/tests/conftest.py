"""Shared test fixtures for generative_ai_processor.
Domain: authentication | Port: 8261 | NS: jtp
...
SERVICE_NAME   = "generative_ai_processor"
SERVICE_PORT   = 8261
...
def service_name():
    return "generative_ai_processor"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/generative_ai_processor"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-generative_ai_processor",
        "X-Service-Name": "generative_ai_processor",
...
def expected_service_meta():
    ...
    return {
        "service": "generative_ai_processor",
