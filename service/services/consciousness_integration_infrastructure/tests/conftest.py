"""Shared test fixtures for consciousness_integration_infrastructure.
Domain: biological | Port: 8302 | NS: jtp
...
SERVICE_NAME   = "consciousness_integration_infrastructure"
SERVICE_PORT   = 8302
...
def service_name():
    return "consciousness_integration_infrastructure"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/consciousness_integration_infrastructure"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-consciousness_integration_infrastructure",
        "X-Service-Name": "consciousness_integration_infrastructure",
        "X-Domain": "biological",
    }
