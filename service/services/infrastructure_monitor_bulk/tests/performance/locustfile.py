"""Performance tests for infrastructure_monitor_bulk.
Port: 8200 | Rate limit: 1000 rpm
...
class InfrastructureMonitorBulkUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/infrastructure_monitor_bulk/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/infrastructure_monitor_bulk/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/infrastructure_monitor_bulk/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/infrastructure_monitor_bulk/health")
