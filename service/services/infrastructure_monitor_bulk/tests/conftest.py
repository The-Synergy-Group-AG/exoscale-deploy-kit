"""Shared test fixtures for infrastructure_monitor_bulk.
Domain: monitoring | Port: 8200 | NS: jtp
...
SERVICE_NAME   = "infrastructure_monitor_bulk"
SERVICE_PORT   = 8200
...
def service_name():
    return "infrastructure_monitor_bulk"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/infrastructure_monitor_bulk"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-infrastructure_monitor_bulk",
        "X-Service-Name": "infrastructure_monitor_bulk",
        "X-Domain": "monitoring",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "infrastructure_monitor_bulk",
        "domain": "monitoring",
        "resource_tier": "small",
        "port": 8200,
        "harmony_target": 0.997,
