"""User Story Acceptance Tests — infrastructure_monitor_bulk
US: US-097..US-0630 (89 stories) | Port: 8200 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/infrastructure_monitor_bulk"
SERVICE_PORT  = 8200


class TestInfrastructureMonitorBulkUserStories:
