"""Shared test fixtures for reinforcement_learning_system.
Domain: ai | Port: 8253 | NS: jtp
...
SERVICE_NAME   = "reinforcement_learning_system"
SERVICE_PORT   = 8253
...
def service_name():
    return "reinforcement_learning_system"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/reinforcement_learning_system"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-reinforcement_learning_system",
        "X-Service-Name": "reinforcement_learning_system",
        "X-Domain": "ai",
    }
