"""Performance tests for reinforcement_learning_system.
Port: 8253 | Rate limit: 1000 rpm
...
class ReinforcementLearningSystemUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/reinforcement_learning_system/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/reinforcement_learning_system/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.post("/api/reinforcement_learning_system/ai/process",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/reinforcement_learning_system/health")
