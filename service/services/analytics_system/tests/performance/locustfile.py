"""Performance tests for analytics_system.
Port: 8182 | Rate limit: 1000 rpm
...
class AnalyticsSystemUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/analytics_system/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/analytics_system/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/analytics_system/analytics/dashboard",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/analytics_system/health")
