"""Shared test fixtures for analytics_system.
Domain: analytics | Port: 8182 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/analytics_system"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-analytics_system",
        "X-Service-Name": "analytics_system",
        "X-Domain": "analytics",
    }
