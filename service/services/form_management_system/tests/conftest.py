"""Shared test fixtures for form_management_system.
Domain: workflow | Port: 8259 | NS: jtp
...
SERVICE_NAME   = "form_management_system"
SERVICE_PORT   = 8259
...
def service_base(gateway_url):
    return f"{gateway_url}/api/form_management_system"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-form_management_system",
        "X-Service-Name": "form_management_system",
        "X-Domain": "workflow",
    }
