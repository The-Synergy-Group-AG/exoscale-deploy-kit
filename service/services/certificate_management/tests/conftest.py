"""Shared test fixtures for certificate_management.
Domain: security | Port: 8100 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/certificate_management"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-certificate_management",
        "X-Service-Name": "certificate_management",
        "X-Domain": "security",
    }
