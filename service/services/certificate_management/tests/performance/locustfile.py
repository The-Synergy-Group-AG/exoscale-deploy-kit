"""Performance tests for certificate_management.
Port: 8100 | Rate limit: 1000 rpm
...
class CertificateManagementUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/certificate_management/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/certificate_management/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/certificate_management/security/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/certificate_management/health")
