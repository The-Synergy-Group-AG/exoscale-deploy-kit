"""Shared test fixtures for user_profile_manager_service.
Domain: user_management | Port: 8191 | NS: jtp
...
SERVICE_NAME   = "user_profile_manager_service"
SERVICE_PORT   = 8191
...
def service_name():
    return "user_profile_manager_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/user_profile_manager_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-user_profile_manager_service",
        "X-Service-Name": "user_profile_manager_service",
