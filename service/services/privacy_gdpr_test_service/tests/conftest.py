"""Shared test fixtures for privacy_gdpr_test_service.
Domain: compliance | Port: 8255 | NS: jtp
...
SERVICE_NAME   = "privacy_gdpr_test_service"
SERVICE_PORT   = 8255
...
def service_name():
    return "privacy_gdpr_test_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/privacy_gdpr_test_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-privacy_gdpr_test_service",
        "X-Service-Name": "privacy_gdpr_test_service",
        "X-Domain": "compliance",
    }
