"""Performance tests for comprehensive_endpoint_test_execution.
Port: 8122 | Rate limit: 1000 rpm
...
class ComprehensiveEndpointTestExecutionUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/comprehensive_endpoint_test_execution/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/comprehensive_endpoint_test_execution/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/comprehensive_endpoint_test_execution/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/comprehensive_endpoint_test_execution/health")
