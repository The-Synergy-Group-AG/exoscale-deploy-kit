"""Shared test fixtures for comprehensive_endpoint_test_execution.
Domain: monitoring | Port: 8122 | NS: jtp
...
SERVICE_NAME   = "comprehensive_endpoint_test_execution"
SERVICE_PORT   = 8122
...
def service_name():
    return "comprehensive_endpoint_test_execution"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/comprehensive_endpoint_test_execution"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-comprehensive_endpoint_test_execution",
        "X-Service-Name": "comprehensive_endpoint_test_execution",
        "X-Domain": "monitoring",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "comprehensive_endpoint_test_execution",
        "domain": "monitoring",
        "resource_tier": "small",
        "port": 8122,
        "harmony_target": 0.997,
