"""User Story Acceptance Tests — swiss_market_service
US: US-357..US-0611 (55 stories) | Port: 8183 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/swiss_market_service"
SERVICE_PORT  = 8183


class TestSwissMarketServiceUserStories:
