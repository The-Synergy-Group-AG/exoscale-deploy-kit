"""Shared test fixtures for swiss_market_service.
Domain: compliance | Port: 8183 | NS: jtp
...
SERVICE_NAME   = "swiss_market_service"
SERVICE_PORT   = 8183
...
def service_base(gateway_url):
    return f"{gateway_url}/api/swiss_market_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-swiss_market_service",
        "X-Service-Name": "swiss_market_service",
        "X-Domain": "compliance",
    }
