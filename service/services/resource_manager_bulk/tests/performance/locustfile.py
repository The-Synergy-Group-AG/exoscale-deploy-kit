"""Performance tests for resource_manager_bulk.
Port: 8199 | Rate limit: 1000 rpm
...
class ResourceManagerBulkUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/resource_manager_bulk/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/resource_manager_bulk/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/resource_manager_bulk/workflows",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/resource_manager_bulk/health")
