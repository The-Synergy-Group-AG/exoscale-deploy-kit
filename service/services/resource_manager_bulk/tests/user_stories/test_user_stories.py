"""User Story Acceptance Tests — resource_manager_bulk
US: US-001..US-0601 (241 stories) | Port: 8199 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/resource_manager_bulk"
SERVICE_PORT  = 8199


class TestResourceManagerBulkUserStories:
