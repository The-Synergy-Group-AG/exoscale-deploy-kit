"""Shared test fixtures for resource_manager_bulk.
Domain: workflow | Port: 8199 | NS: jtp
...
SERVICE_NAME   = "resource_manager_bulk"
SERVICE_PORT   = 8199
...
def service_base(gateway_url):
    return f"{gateway_url}/api/resource_manager_bulk"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-resource_manager_bulk",
        "X-Service-Name": "resource_manager_bulk",
        "X-Domain": "workflow",
    }
