"""User Story Acceptance Tests — cv_generation_service
US: US-280..US-323 (28 stories) | Port: 8119 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/cv_generation_service"
SERVICE_PORT  = 8119


class TestCvGenerationServiceUserStories:
