"""Shared test fixtures for cv_generation_service.
Domain: career | Port: 8119 | NS: jtp
...
SERVICE_NAME   = "cv_generation_service"
SERVICE_PORT   = 8119
...
def service_base(gateway_url):
    return f"{gateway_url}/api/cv_generation_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-cv_generation_service",
        "X-Service-Name": "cv_generation_service",
        "X-Domain": "career",
    }
