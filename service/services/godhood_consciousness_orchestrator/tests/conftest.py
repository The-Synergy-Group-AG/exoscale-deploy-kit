"""Shared test fixtures for godhood_consciousness_orchestrator.
Domain: biological | Port: 8173 | NS: jtp
...
SERVICE_NAME   = "godhood_consciousness_orchestrator"
SERVICE_PORT   = 8173
...
def service_name():
    return "godhood_consciousness_orchestrator"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/godhood_consciousness_orchestrator"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-godhood_consciousness_orchestrator",
        "X-Service-Name": "godhood_consciousness_orchestrator",
        "X-Domain": "biological",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "godhood_consciousness_orchestrator",
        "domain": "biological",
        "resource_tier": "xlarge",
        "port": 8173,
        "harmony_target": 0.997,
