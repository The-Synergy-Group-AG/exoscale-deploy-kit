"""Shared test fixtures for predictive_analytics_engine.
Domain: analytics | Port: 8178 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/predictive_analytics_engine"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-predictive_analytics_engine",
        "X-Service-Name": "predictive_analytics_engine",
        "X-Domain": "analytics",
    }
