"""Performance tests for user_profile_service.
Port: 8142 | Rate limit: 1000 rpm
...
class UserProfileServiceUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/user_profile_service/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/user_profile_service/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/user_profile_service/users",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/user_profile_service/health")
