"""Shared test fixtures for user_profile_service.
Domain: user_management | Port: 8142 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/user_profile_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-user_profile_service",
        "X-Service-Name": "user_profile_service",
