"""Shared test fixtures for test_coverage_analysis_service.
Domain: monitoring | Port: 8256 | NS: jtp
...
SERVICE_NAME   = "test_coverage_analysis_service"
SERVICE_PORT   = 8256
...
def service_name():
    return "test_coverage_analysis_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/test_coverage_analysis_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-test_coverage_analysis_service",
        "X-Service-Name": "test_coverage_analysis_service",
        "X-Domain": "monitoring",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "test_coverage_analysis_service",
        "domain": "monitoring",
        "resource_tier": "small",
        "port": 8256,
        "harmony_target": 0.997,
