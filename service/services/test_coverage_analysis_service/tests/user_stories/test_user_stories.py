"""User Story Acceptance Tests — test_coverage_analysis_service
US: US-097..US-0630 (89 stories) | Port: 8256 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/test_coverage_analysis_service"
SERVICE_PORT  = 8256


class TestTestCoverageAnalysisServiceUserStories:
