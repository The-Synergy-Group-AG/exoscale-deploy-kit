"""Shared test fixtures for consciousness_evolution_state_tracker.
Domain: biological | Port: 8125 | NS: jtp
...
SERVICE_NAME   = "consciousness_evolution_state_tracker"
SERVICE_PORT   = 8125
...
def service_name():
    return "consciousness_evolution_state_tracker"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/consciousness_evolution_state_tracker"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-consciousness_evolution_state_tracker",
        "X-Service-Name": "consciousness_evolution_state_tracker",
        "X-Domain": "biological",
    }
