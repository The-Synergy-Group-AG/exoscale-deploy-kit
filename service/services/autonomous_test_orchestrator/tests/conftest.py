"""Shared test fixtures for autonomous_test_orchestrator.
Domain: monitoring | Port: 8294 | NS: jtp
...
SERVICE_NAME   = "autonomous_test_orchestrator"
SERVICE_PORT   = 8294
...
def service_base(gateway_url):
    return f"{gateway_url}/api/autonomous_test_orchestrator"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-autonomous_test_orchestrator",
        "X-Service-Name": "autonomous_test_orchestrator",
        "X-Domain": "monitoring",
    }
