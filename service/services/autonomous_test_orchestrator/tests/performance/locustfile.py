"""Performance tests for autonomous_test_orchestrator.
Port: 8294 | Rate limit: 1000 rpm
...
class AutonomousTestOrchestratorUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/autonomous_test_orchestrator/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/autonomous_test_orchestrator/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/autonomous_test_orchestrator/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/autonomous_test_orchestrator/health")
