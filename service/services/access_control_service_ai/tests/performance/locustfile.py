"""Performance tests for access_control_service_ai.
Port: 8090 | Rate limit: 1000 rpm
...
class AccessControlServiceAiUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/access_control_service_ai/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/access_control_service_ai/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/access_control_service_ai/security/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/access_control_service_ai/health")
