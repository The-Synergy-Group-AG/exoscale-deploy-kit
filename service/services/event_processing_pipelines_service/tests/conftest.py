"""Shared test fixtures for event_processing_pipelines_service.
Domain: workflow | Port: 8091 | NS: jtp
...
SERVICE_NAME   = "event_processing_pipelines_service"
SERVICE_PORT   = 8091
...
def service_name():
    return "event_processing_pipelines_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/event_processing_pipelines_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-event_processing_pipelines_service",
        "X-Service-Name": "event_processing_pipelines_service",
        "X-Domain": "workflow",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "event_processing_pipelines_service",
        "domain": "workflow",
        "resource_tier": "medium",
        "port": 8091,
        "harmony_target": 0.997,
