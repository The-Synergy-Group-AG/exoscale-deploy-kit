"""User Story Acceptance Tests — event_processing_pipelines_service
US: US-001..US-0601 (241 stories) | Port: 8091 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/event_processing_pipelines_service"
SERVICE_PORT  = 8091


class TestEventProcessingPipelinesServiceUserStories:
