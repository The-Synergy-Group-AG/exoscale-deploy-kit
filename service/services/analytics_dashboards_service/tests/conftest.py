"""Shared test fixtures for analytics_dashboards_service.
Domain: analytics | Port: 8266 | NS: jtp
...
SERVICE_NAME   = "analytics_dashboards_service"
SERVICE_PORT   = 8266
...
def service_name():
    return "analytics_dashboards_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/analytics_dashboards_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-analytics_dashboards_service",
        "X-Service-Name": "analytics_dashboards_service",
        "X-Domain": "analytics",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "analytics_dashboards_service",
        "domain": "analytics",
        "resource_tier": "medium",
        "port": 8266,
        "harmony_target": 0.997,
