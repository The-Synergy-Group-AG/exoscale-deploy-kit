"""Shared test fixtures for gamification_service.
Domain: gamification | Port: 8111 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/gamification_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-gamification_service",
        "X-Service-Name": "gamification_service",
