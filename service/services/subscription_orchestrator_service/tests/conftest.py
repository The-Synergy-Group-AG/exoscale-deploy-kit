"""Shared test fixtures for subscription_orchestrator_service.
Domain: payment | Port: 8223 | NS: jtp
...
SERVICE_NAME   = "subscription_orchestrator_service"
SERVICE_PORT   = 8223
...
def service_name():
    return "subscription_orchestrator_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/subscription_orchestrator_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-subscription_orchestrator_service",
        "X-Service-Name": "subscription_orchestrator_service",
        "X-Domain": "payment",
    }
