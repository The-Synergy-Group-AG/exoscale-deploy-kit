"""Performance tests for subscription_orchestrator_service.
Port: 8223 | Rate limit: 1000 rpm
...
class SubscriptionOrchestratorServiceUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/subscription_orchestrator_service/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/subscription_orchestrator_service/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/subscription_orchestrator_service/payments",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/subscription_orchestrator_service/health")
