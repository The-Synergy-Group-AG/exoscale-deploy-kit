"""Security tests for subscription_orchestrator_service.
Port: 8223 | Encryption: advanced | Audit retention: 365 days
OWASP Top 10 — Plan 123 Phase 3 (7 security tests).
Variables from CENTRAL_VARIABLE_REGISTRY.
"""
import pytest, httpx

SERVICE_BASE  = "http://151.145.202.116:30671/api/subscription_orchestrator_service"
SERVICE_PORT  = 8223
ENC_LEVEL     = "advanced"


class TestSubscriptionOrchestratorServiceSecurity:
