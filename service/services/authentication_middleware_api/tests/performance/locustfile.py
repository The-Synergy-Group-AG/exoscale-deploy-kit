"""Performance tests for authentication_middleware_api.
Port: 8288 | Rate limit: 1000 rpm
...
class AuthenticationMiddlewareApiUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/authentication_middleware_api/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/authentication_middleware_api/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/authentication_middleware_api/auth/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/authentication_middleware_api/health")
