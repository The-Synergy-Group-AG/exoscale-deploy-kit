"""Shared test fixtures for metabolic_system_orchestrator_bulk.
Domain: biological | Port: 8094 | NS: jtp
...
SERVICE_NAME   = "metabolic_system_orchestrator_bulk"
SERVICE_PORT   = 8094
...
def service_name():
    return "metabolic_system_orchestrator_bulk"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/metabolic_system_orchestrator_bulk"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-metabolic_system_orchestrator_bulk",
        "X-Service-Name": "metabolic_system_orchestrator_bulk",
        "X-Domain": "biological",
    }
