"""User Story Acceptance Tests — metabolic_system_orchestrator_bulk
US: US-143..US-279 (115 stories) | Port: 8094 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/metabolic_system_orchestrator_bulk"
SERVICE_PORT  = 8094


class TestMetabolicSystemOrchestratorBulkUserStories:
