"""Performance tests for interview_prep_service.
Port: 8220 | Rate limit: 1000 rpm
...
class InterviewPrepServiceUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/interview_prep_service/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/interview_prep_service/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/interview_prep_service/jobs",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/interview_prep_service/health")
