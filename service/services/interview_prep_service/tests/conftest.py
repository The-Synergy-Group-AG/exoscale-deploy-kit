"""Shared test fixtures for interview_prep_service.
Domain: career | Port: 8220 | NS: jtp
...
SERVICE_NAME   = "interview_prep_service"
SERVICE_PORT   = 8220
...
def service_base(gateway_url):
    return f"{gateway_url}/api/interview_prep_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-interview_prep_service",
        "X-Service-Name": "interview_prep_service",
        "X-Domain": "career",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "interview_prep_service",
        "domain": "career",
        "resource_tier": "medium",
        "port": 8220,
        "harmony_target": 0.997,
