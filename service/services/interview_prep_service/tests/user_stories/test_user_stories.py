"""User Story Acceptance Tests — interview_prep_service
US: US-280..US-323 (28 stories) | Port: 8220 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/interview_prep_service"
SERVICE_PORT  = 8220


class TestInterviewPrepServiceUserStories:
