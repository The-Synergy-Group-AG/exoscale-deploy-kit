"""Shared test fixtures for subscription_service.
Domain: payment | Port: 8204 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/subscription_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-subscription_service",
        "X-Service-Name": "subscription_service",
        "X-Domain": "payment",
    }
