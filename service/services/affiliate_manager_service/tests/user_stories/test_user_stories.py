"""User Story Acceptance Tests — affiliate_manager_service
US: US-001..US-0601 (241 stories) | Port: 8276 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/affiliate_manager_service"
SERVICE_PORT  = 8276


class TestAffiliateManagerServiceUserStories:
