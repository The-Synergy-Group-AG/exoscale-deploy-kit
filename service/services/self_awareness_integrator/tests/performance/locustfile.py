"""Performance tests for self_awareness_integrator.
Port: 8176 | Rate limit: 1000 rpm
...
class SelfAwarenessIntegratorUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/self_awareness_integrator/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/self_awareness_integrator/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/self_awareness_integrator/biological/harmony",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/self_awareness_integrator/health")
