"""Security tests for self_awareness_integrator.
Port: 8176 | Encryption: advanced | Audit retention: 365 days
OWASP Top 10 — Plan 123 Phase 3 (7 security tests).
Variables from CENTRAL_VARIABLE_REGISTRY.
"""
import pytest, httpx

SERVICE_BASE  = "http://151.145.202.116:30671/api/self_awareness_integrator"
SERVICE_PORT  = 8176
ENC_LEVEL     = "advanced"


class TestSelfAwarenessIntegratorSecurity:
