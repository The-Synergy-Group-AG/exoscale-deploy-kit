"""Security tests for personalization_ai_adaptor.
Port: 8087 | Encryption: advanced | Audit retention: 365 days
OWASP Top 10 — Plan 123 Phase 3 (7 security tests).
Variables from CENTRAL_VARIABLE_REGISTRY.
"""
import pytest, httpx

SERVICE_BASE  = "http://151.145.202.116:30671/api/personalization_ai_adaptor"
SERVICE_PORT  = 8087
ENC_LEVEL     = "advanced"


class TestPersonalizationAiAdaptorSecurity:
