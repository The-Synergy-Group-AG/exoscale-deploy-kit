"""User Story Acceptance Tests — personalization_ai_adaptor
US: US-410..US-0683 (90 stories) | Port: 8087 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/personalization_ai_adaptor"
SERVICE_PORT  = 8087


class TestPersonalizationAiAdaptorUserStories:
