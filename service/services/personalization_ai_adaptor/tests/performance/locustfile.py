"""Performance tests for personalization_ai_adaptor.
Port: 8087 | Rate limit: 1000 rpm
...
class PersonalizationAiAdaptorUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/personalization_ai_adaptor/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/personalization_ai_adaptor/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.post("/api/personalization_ai_adaptor/ai/process",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/personalization_ai_adaptor/health")
