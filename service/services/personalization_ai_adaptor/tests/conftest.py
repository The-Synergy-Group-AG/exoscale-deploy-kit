"""Shared test fixtures for personalization_ai_adaptor.
Domain: ai | Port: 8087 | NS: jtp
...
SERVICE_NAME   = "personalization_ai_adaptor"
SERVICE_PORT   = 8087
...
def service_name():
    return "personalization_ai_adaptor"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/personalization_ai_adaptor"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-personalization_ai_adaptor",
        "X-Service-Name": "personalization_ai_adaptor",
        "X-Domain": "ai",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "personalization_ai_adaptor",
        "domain": "ai",
        "resource_tier": "large",
        "port": 8087,
        "harmony_target": 0.997,
