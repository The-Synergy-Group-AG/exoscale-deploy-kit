"""Shared test fixtures for test_api_rate_limiting_validation.
Domain: monitoring | Port: 8180 | NS: jtp
...
SERVICE_NAME   = "test_api_rate_limiting_validation"
SERVICE_PORT   = 8180
...
def service_name():
    return "test_api_rate_limiting_validation"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/test_api_rate_limiting_validation"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-test_api_rate_limiting_validation",
        "X-Service-Name": "test_api_rate_limiting_validation",
        "X-Domain": "monitoring",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "test_api_rate_limiting_validation",
        "domain": "monitoring",
        "resource_tier": "small",
        "port": 8180,
        "harmony_target": 0.997,
