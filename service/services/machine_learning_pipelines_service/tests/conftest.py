"""Shared test fixtures for machine_learning_pipelines_service.
Domain: ai | Port: 8257 | NS: jtp
...
SERVICE_NAME   = "machine_learning_pipelines_service"
SERVICE_PORT   = 8257
...
def service_name():
    return "machine_learning_pipelines_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/machine_learning_pipelines_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-machine_learning_pipelines_service",
        "X-Service-Name": "machine_learning_pipelines_service",
        "X-Domain": "ai",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "machine_learning_pipelines_service",
        "domain": "ai",
        "resource_tier": "large",
        "port": 8257,
        "harmony_target": 0.997,
