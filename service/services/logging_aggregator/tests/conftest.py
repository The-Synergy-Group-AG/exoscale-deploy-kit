"""Shared test fixtures for logging_aggregator.
Domain: monitoring | Port: 8229 | NS: jtp
...
SERVICE_NAME   = "logging_aggregator"
SERVICE_PORT   = 8229
...
def service_base(gateway_url):
    return f"{gateway_url}/api/logging_aggregator"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-logging_aggregator",
        "X-Service-Name": "logging_aggregator",
        "X-Domain": "monitoring",
    }
