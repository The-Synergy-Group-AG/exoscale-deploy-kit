"""User Story Acceptance Tests — logging_aggregator
US: US-097..US-0630 (89 stories) | Port: 8229 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/logging_aggregator"
SERVICE_PORT  = 8229


class TestLoggingAggregatorUserStories:
