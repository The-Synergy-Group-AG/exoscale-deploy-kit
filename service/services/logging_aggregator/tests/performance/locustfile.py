"""Performance tests for logging_aggregator.
Port: 8229 | Rate limit: 1000 rpm
...
class LoggingAggregatorUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/logging_aggregator/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/logging_aggregator/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/logging_aggregator/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/logging_aggregator/health")
