"""Performance tests for payment-billing-frontend.
Port: 8127 | Rate limit: 1000 rpm
...
class PaymentBillingFrontendUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/payment-billing-frontend/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/payment-billing-frontend/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/payment-billing-frontend/api/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/payment-billing-frontend/health")
