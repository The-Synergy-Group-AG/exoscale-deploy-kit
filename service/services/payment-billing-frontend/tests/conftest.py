"""Shared test fixtures for payment-billing-frontend.
Domain: frontend | Port: 8127 | NS: jtp
...
SERVICE_NAME   = "payment-billing-frontend"
SERVICE_PORT   = 8127
...
def service_name():
    return "payment-billing-frontend"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/payment-billing-frontend"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-payment-billing-frontend",
        "X-Service-Name": "payment-billing-frontend",
        "X-Domain": "frontend",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "payment-billing-frontend",
        "domain": "frontend",
        "resource_tier": "small",
        "port": 8127,
        "harmony_target": 0.997,
