"""Shared test fixtures for reproductive_system_biological.
Domain: biological | Port: 8284 | NS: jtp
...
SERVICE_NAME   = "reproductive_system_biological"
SERVICE_PORT   = 8284
...
def service_name():
    return "reproductive_system_biological"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/reproductive_system_biological"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-reproductive_system_biological",
        "X-Service-Name": "reproductive_system_biological",
        "X-Domain": "biological",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "reproductive_system_biological",
        "domain": "biological",
        "resource_tier": "large",
        "port": 8284,
        "harmony_target": 0.997,
