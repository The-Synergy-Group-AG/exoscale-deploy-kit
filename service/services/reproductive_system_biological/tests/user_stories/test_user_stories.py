"""User Story Acceptance Tests — reproductive_system_biological
US: US-143..US-279 (115 stories) | Port: 8284 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/reproductive_system_biological"
SERVICE_PORT  = 8284


class TestReproductiveSystemBiologicalUserStories:
