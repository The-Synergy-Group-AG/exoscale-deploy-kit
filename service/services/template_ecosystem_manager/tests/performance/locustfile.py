"""Performance tests for template_ecosystem_manager.
Port: 8197 | Rate limit: 1000 rpm
...
class TemplateEcosystemManagerUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/template_ecosystem_manager/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/template_ecosystem_manager/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/template_ecosystem_manager/config",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/template_ecosystem_manager/health")
