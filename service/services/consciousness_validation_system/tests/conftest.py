"""Shared test fixtures for consciousness_validation_system.
Domain: biological | Port: 8092 | NS: jtp
...
SERVICE_NAME   = "consciousness_validation_system"
SERVICE_PORT   = 8092
...
def service_name():
    return "consciousness_validation_system"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/consciousness_validation_system"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-consciousness_validation_system",
        "X-Service-Name": "consciousness_validation_system",
        "X-Domain": "biological",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "consciousness_validation_system",
        "domain": "biological",
        "resource_tier": "large",
        "port": 8092,
        "harmony_target": 0.997,
