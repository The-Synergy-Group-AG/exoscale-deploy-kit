"""Shared test fixtures for tab_sync_service.
Domain: workflow | Port: 8274 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/tab_sync_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-tab_sync_service",
        "X-Service-Name": "tab_sync_service",
        "X-Domain": "workflow",
    }
