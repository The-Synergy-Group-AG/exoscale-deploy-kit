"""User Story Acceptance Tests — tab_sync_service
US: US-001..US-0601 (241 stories) | Port: 8274 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/tab_sync_service"
SERVICE_PORT  = 8274


class TestTabSyncServiceUserStories:
