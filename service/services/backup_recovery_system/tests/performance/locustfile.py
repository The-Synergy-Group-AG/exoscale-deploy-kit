"""Performance tests for backup_recovery_system.
Port: 8224 | Rate limit: 1000 rpm
...
class BackupRecoverySystemUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/backup_recovery_system/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/backup_recovery_system/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/backup_recovery_system/backup/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/backup_recovery_system/health")
