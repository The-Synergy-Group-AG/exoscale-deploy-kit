"""Shared test fixtures for backup_recovery_system.
Domain: backup | Port: 8224 | NS: jtp
...
SERVICE_NAME   = "backup_recovery_system"
SERVICE_PORT   = 8224
...
def service_base(gateway_url):
    return f"{gateway_url}/api/backup_recovery_system"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-backup_recovery_system",
        "X-Service-Name": "backup_recovery_system",
        "X-Domain": "backup",
    }
