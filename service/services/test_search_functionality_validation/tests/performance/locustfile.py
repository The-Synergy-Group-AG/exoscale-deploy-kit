"""Performance tests for test_search_functionality_validation.
Port: 8190 | Rate limit: 1000 rpm
...
class TestSearchFunctionalityValidationUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/test_search_functionality_validation/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/test_search_functionality_validation/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/test_search_functionality_validation/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/test_search_functionality_validation/health")
