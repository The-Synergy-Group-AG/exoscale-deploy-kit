"""Shared test fixtures for test_search_functionality_validation.
Domain: monitoring | Port: 8190 | NS: jtp
...
SERVICE_NAME   = "test_search_functionality_validation"
SERVICE_PORT   = 8190
...
def service_name():
    return "test_search_functionality_validation"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/test_search_functionality_validation"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-test_search_functionality_validation",
        "X-Service-Name": "test_search_functionality_validation",
        "X-Domain": "monitoring",
    }
