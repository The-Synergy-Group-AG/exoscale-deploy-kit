"""Performance tests for subscription_management_service.
Port: 8293 | Rate limit: 1000 rpm
...
class SubscriptionManagementServiceUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/subscription_management_service/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/subscription_management_service/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/subscription_management_service/payments",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/subscription_management_service/health")
