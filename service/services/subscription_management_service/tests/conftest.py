"""Shared test fixtures for subscription_management_service.
Domain: payment | Port: 8293 | NS: jtp
...
SERVICE_NAME   = "subscription_management_service"
SERVICE_PORT   = 8293
...
def service_base(gateway_url):
    return f"{gateway_url}/api/subscription_management_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-subscription_management_service",
        "X-Service-Name": "subscription_management_service",
        "X-Domain": "payment",
    }
