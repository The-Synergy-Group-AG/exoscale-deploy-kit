"""Shared test fixtures for rav-compliance-frontend.
Domain: frontend | Port: 8228 | NS: jtp
...
SERVICE_NAME   = "rav-compliance-frontend"
SERVICE_PORT   = 8228
...
def service_name():
    return "rav-compliance-frontend"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/rav-compliance-frontend"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-rav-compliance-frontend",
        "X-Service-Name": "rav-compliance-frontend",
        "X-Domain": "frontend",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "rav-compliance-frontend",
        "domain": "frontend",
        "resource_tier": "small",
        "port": 8228,
        "harmony_target": 0.997,
