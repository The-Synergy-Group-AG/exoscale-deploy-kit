"""User Story Acceptance Tests — rav-compliance-frontend
US: US-324..US-0622 (35 stories) | Port: 8228 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/rav-compliance-frontend"
SERVICE_PORT  = 8228


class TestRavComplianceFrontendUserStories:
