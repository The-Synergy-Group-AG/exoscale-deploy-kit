"""Shared test fixtures for crm_integration_service.
Domain: workflow | Port: 8271 | NS: jtp
...
SERVICE_NAME   = "crm_integration_service"
SERVICE_PORT   = 8271
...
def service_name():
    return "crm_integration_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/crm_integration_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-crm_integration_service",
        "X-Service-Name": "crm_integration_service",
        "X-Domain": "workflow",
    }
