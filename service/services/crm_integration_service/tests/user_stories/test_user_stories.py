"""User Story Acceptance Tests — crm_integration_service
US: US-001..US-0601 (241 stories) | Port: 8271 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/crm_integration_service"
SERVICE_PORT  = 8271


class TestCrmIntegrationServiceUserStories:
