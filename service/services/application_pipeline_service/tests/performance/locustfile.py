"""Performance tests for application_pipeline_service.
Port: 8298 | Rate limit: 1000 rpm
...
class ApplicationPipelineServiceUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/application_pipeline_service/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/application_pipeline_service/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/application_pipeline_service/workflows",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/application_pipeline_service/health")
