"""User Story Acceptance Tests — application_pipeline_service
US: US-001..US-0601 (241 stories) | Port: 8298 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/application_pipeline_service"
SERVICE_PORT  = 8298


class TestApplicationPipelineServiceUserStories:
