"""Shared test fixtures for application_pipeline_service.
Domain: workflow | Port: 8298 | NS: jtp
...
SERVICE_NAME   = "application_pipeline_service"
SERVICE_PORT   = 8298
...
def service_name():
    return "application_pipeline_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/application_pipeline_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-application_pipeline_service",
        "X-Service-Name": "application_pipeline_service",
        "X-Domain": "workflow",
    }
