"""Shared test fixtures for networking_service.
Domain: general | Port: 8162 | NS: jtp
...
SERVICE_NAME   = "networking_service"
SERVICE_PORT   = 8162
...
def service_base(gateway_url):
    return f"{gateway_url}/api/networking_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-networking_service",
        "X-Service-Name": "networking_service",
        "X-Domain": "general",
    }
