"""Shared test fixtures for advanced_ai_ml_service.
Domain: ai | Port: 8234 | NS: jtp
...
SERVICE_NAME   = "advanced_ai_ml_service"
SERVICE_PORT   = 8234
...
def service_base(gateway_url):
    return f"{gateway_url}/api/advanced_ai_ml_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-advanced_ai_ml_service",
        "X-Service-Name": "advanced_ai_ml_service",
        "X-Domain": "ai",
    }
