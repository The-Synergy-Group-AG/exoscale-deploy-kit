"""Shared test fixtures for predictive_analytics_engine_ai.
Domain: analytics | Port: 8149 | NS: jtp
...
SERVICE_NAME   = "predictive_analytics_engine_ai"
SERVICE_PORT   = 8149
...
def service_name():
    return "predictive_analytics_engine_ai"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/predictive_analytics_engine_ai"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-predictive_analytics_engine_ai",
        "X-Service-Name": "predictive_analytics_engine_ai",
        "X-Domain": "analytics",
    }
