"""Shared test fixtures for neural_network_processor.
Domain: authentication | Port: 8214 | NS: jtp
...
SERVICE_NAME   = "neural_network_processor"
SERVICE_PORT   = 8214
...
def service_base(gateway_url):
    return f"{gateway_url}/api/neural_network_processor"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-neural_network_processor",
        "X-Service-Name": "neural_network_processor",
...
def expected_service_meta():
    ...
    return {
        "service": "neural_network_processor",
