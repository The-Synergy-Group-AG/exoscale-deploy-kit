"""Shared test fixtures for test_flakiness_analysis_service.
Domain: monitoring | Port: 8278 | NS: jtp
...
SERVICE_NAME   = "test_flakiness_analysis_service"
SERVICE_PORT   = 8278
...
def service_name():
    return "test_flakiness_analysis_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/test_flakiness_analysis_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-test_flakiness_analysis_service",
        "X-Service-Name": "test_flakiness_analysis_service",
        "X-Domain": "monitoring",
    }
