"""User Story Acceptance Tests — test_flakiness_analysis_service
US: US-097..US-0630 (89 stories) | Port: 8278 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/test_flakiness_analysis_service"
SERVICE_PORT  = 8278


class TestTestFlakinessAnalysisServiceUserStories:
