"""User Story Acceptance Tests — test_workflow_automation_validation
US: US-097..US-0630 (89 stories) | Port: 8292 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/test_workflow_automation_validation"
SERVICE_PORT  = 8292


class TestTestWorkflowAutomationValidationUserStories:
