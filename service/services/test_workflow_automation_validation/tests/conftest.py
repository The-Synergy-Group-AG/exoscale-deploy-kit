"""Shared test fixtures for test_workflow_automation_validation.
Domain: monitoring | Port: 8292 | NS: jtp
...
SERVICE_NAME   = "test_workflow_automation_validation"
SERVICE_PORT   = 8292
...
def service_name():
    return "test_workflow_automation_validation"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/test_workflow_automation_validation"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-test_workflow_automation_validation",
        "X-Service-Name": "test_workflow_automation_validation",
        "X-Domain": "monitoring",
    }
