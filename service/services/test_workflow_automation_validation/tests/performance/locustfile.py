"""Performance tests for test_workflow_automation_validation.
Port: 8292 | Rate limit: 1000 rpm
...
class TestWorkflowAutomationValidationUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/test_workflow_automation_validation/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/test_workflow_automation_validation/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/test_workflow_automation_validation/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/test_workflow_automation_validation/health")
