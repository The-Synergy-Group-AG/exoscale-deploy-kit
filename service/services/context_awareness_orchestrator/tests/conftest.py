"""Shared test fixtures for context_awareness_orchestrator.
Domain: workflow | Port: 8165 | NS: jtp
...
SERVICE_NAME   = "context_awareness_orchestrator"
SERVICE_PORT   = 8165
...
def service_name():
    return "context_awareness_orchestrator"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/context_awareness_orchestrator"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-context_awareness_orchestrator",
        "X-Service-Name": "context_awareness_orchestrator",
        "X-Domain": "workflow",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "context_awareness_orchestrator",
        "domain": "workflow",
        "resource_tier": "medium",
        "port": 8165,
        "harmony_target": 0.997,
