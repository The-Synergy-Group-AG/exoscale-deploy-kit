"""Performance tests for context_awareness_orchestrator.
Port: 8165 | Rate limit: 1000 rpm
...
class ContextAwarenessOrchestratorUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/context_awareness_orchestrator/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/context_awareness_orchestrator/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/context_awareness_orchestrator/workflows",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/context_awareness_orchestrator/health")
