"""User Story Acceptance Tests — neural_network_validation_service
US: US-097..US-0630 (89 stories) | Port: 8287 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/neural_network_validation_service"
SERVICE_PORT  = 8287


class TestNeuralNetworkValidationServiceUserStories:
