"""Performance tests for neural_network_validation_service.
Port: 8287 | Rate limit: 1000 rpm
...
class NeuralNetworkValidationServiceUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/neural_network_validation_service/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/neural_network_validation_service/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/neural_network_validation_service/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/neural_network_validation_service/health")
