"""Shared test fixtures for neural_network_validation_service.
Domain: monitoring | Port: 8287 | NS: jtp
...
SERVICE_NAME   = "neural_network_validation_service"
SERVICE_PORT   = 8287
...
def service_name():
    return "neural_network_validation_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/neural_network_validation_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-neural_network_validation_service",
        "X-Service-Name": "neural_network_validation_service",
        "X-Domain": "monitoring",
    }
