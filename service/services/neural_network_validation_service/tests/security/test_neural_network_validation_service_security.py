"""Security tests for neural_network_validation_service.
Port: 8287 | Encryption: advanced | Audit retention: 365 days
OWASP Top 10 — Plan 123 Phase 3 (7 security tests).
Variables from CENTRAL_VARIABLE_REGISTRY.
"""
import pytest, httpx

SERVICE_BASE  = "http://151.145.202.116:30671/api/neural_network_validation_service"
SERVICE_PORT  = 8287
ENC_LEVEL     = "advanced"


class TestNeuralNetworkValidationServiceSecurity:
