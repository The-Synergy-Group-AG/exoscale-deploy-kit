"""Performance tests for cellular_communication_network_category.
Port: 8297 | Rate limit: 1000 rpm
...
class CellularCommunicationNetworkCategoryUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/cellular_communication_network_category/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/cellular_communication_network_category/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/cellular_communication_network_category/biological/harmony",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/cellular_communication_network_category/health")
