"""Integration tests for cellular_communication_network_category.
Port: 8297 | Tier: large | Namespace: jtp
...
class TestCellularCommunicationNetworkCategoryIntegration:
