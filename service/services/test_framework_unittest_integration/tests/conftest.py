"""Shared test fixtures for test_framework_unittest_integration.
Domain: monitoring | Port: 8265 | NS: jtp
...
SERVICE_NAME   = "test_framework_unittest_integration"
SERVICE_PORT   = 8265
...
def service_name():
    return "test_framework_unittest_integration"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/test_framework_unittest_integration"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-test_framework_unittest_integration",
        "X-Service-Name": "test_framework_unittest_integration",
        "X-Domain": "monitoring",
    }
