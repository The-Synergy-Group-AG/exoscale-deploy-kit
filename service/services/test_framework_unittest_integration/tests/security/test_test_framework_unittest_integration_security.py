"""Security tests for test_framework_unittest_integration.
Port: 8265 | Encryption: advanced | Audit retention: 365 days
OWASP Top 10 — Plan 123 Phase 3 (7 security tests).
Variables from CENTRAL_VARIABLE_REGISTRY.
"""
import pytest, httpx

SERVICE_BASE  = "http://151.145.202.116:30671/api/test_framework_unittest_integration"
SERVICE_PORT  = 8265
ENC_LEVEL     = "advanced"


class TestTestFrameworkUnittestIntegrationSecurity:
