"""User Story Acceptance Tests — test_framework_unittest_integration
US: US-097..US-0630 (89 stories) | Port: 8265 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/test_framework_unittest_integration"
SERVICE_PORT  = 8265


class TestTestFrameworkUnittestIntegrationUserStories:
