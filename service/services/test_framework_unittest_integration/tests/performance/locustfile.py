"""Performance tests for test_framework_unittest_integration.
Port: 8265 | Rate limit: 1000 rpm
...
class TestFrameworkUnittestIntegrationUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/test_framework_unittest_integration/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/test_framework_unittest_integration/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/test_framework_unittest_integration/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/test_framework_unittest_integration/health")
