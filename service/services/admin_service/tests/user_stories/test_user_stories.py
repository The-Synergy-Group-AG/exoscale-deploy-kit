"""User Story Acceptance Tests — admin_service
US: US-001..US-0601 (241 stories) | Port: 8088 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/admin_service"
SERVICE_PORT  = 8088


class TestAdminServiceUserStories:
