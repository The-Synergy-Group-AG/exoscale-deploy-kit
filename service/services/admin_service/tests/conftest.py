"""Shared test fixtures for admin_service.
Domain: user_management | Port: 8088 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/admin_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-admin_service",
        "X-Service-Name": "admin_service",
