"""Shared test fixtures for harmony_optimization_system_category.
Domain: biological | Port: 8160 | NS: jtp
...
SERVICE_NAME   = "harmony_optimization_system_category"
SERVICE_PORT   = 8160
...
def service_name():
    return "harmony_optimization_system_category"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/harmony_optimization_system_category"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-harmony_optimization_system_category",
        "X-Service-Name": "harmony_optimization_system_category",
        "X-Domain": "biological",
    }
