"""Performance tests for harmony_optimization_system_category.
Port: 8160 | Rate limit: 1000 rpm
...
class HarmonyOptimizationSystemCategoryUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/harmony_optimization_system_category/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/harmony_optimization_system_category/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/harmony_optimization_system_category/biological/harmony",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/harmony_optimization_system_category/health")
