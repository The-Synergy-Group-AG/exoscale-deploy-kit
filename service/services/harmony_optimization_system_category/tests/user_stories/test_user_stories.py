"""User Story Acceptance Tests — harmony_optimization_system_category
US: US-143..US-279 (115 stories) | Port: 8160 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/harmony_optimization_system_category"
SERVICE_PORT  = 8160


class TestHarmonyOptimizationSystemCategoryUserStories:
