"""Shared test fixtures for analytics_platform_service.
Domain: analytics | Port: 8289 | NS: jtp
...
SERVICE_NAME   = "analytics_platform_service"
SERVICE_PORT   = 8289
...
def service_name():
    return "analytics_platform_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/analytics_platform_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-analytics_platform_service",
        "X-Service-Name": "analytics_platform_service",
        "X-Domain": "analytics",
    }
