"""Shared test fixtures for circulatory_system_biological.
Domain: biological | Port: 8109 | NS: jtp
...
SERVICE_NAME   = "circulatory_system_biological"
SERVICE_PORT   = 8109
...
def service_name():
    return "circulatory_system_biological"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/circulatory_system_biological"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-circulatory_system_biological",
        "X-Service-Name": "circulatory_system_biological",
        "X-Domain": "biological",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "circulatory_system_biological",
        "domain": "biological",
        "resource_tier": "large",
        "port": 8109,
        "harmony_target": 0.997,
