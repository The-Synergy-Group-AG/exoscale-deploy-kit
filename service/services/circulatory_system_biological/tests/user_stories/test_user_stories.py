"""User Story Acceptance Tests — circulatory_system_biological
US: US-143..US-279 (115 stories) | Port: 8109 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/circulatory_system_biological"
SERVICE_PORT  = 8109


class TestCirculatorySystemBiologicalUserStories:
