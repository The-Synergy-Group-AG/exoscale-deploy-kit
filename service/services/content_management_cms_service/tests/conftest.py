"""Shared test fixtures for content_management_cms_service.
Domain: document | Port: 8279 | NS: jtp
...
SERVICE_NAME   = "content_management_cms_service"
SERVICE_PORT   = 8279
...
def service_name():
    return "content_management_cms_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/content_management_cms_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-content_management_cms_service",
        "X-Service-Name": "content_management_cms_service",
        "X-Domain": "document",
    }
