"""Shared test fixtures for monitoring_system_bulk.
Domain: monitoring | Port: 8159 | NS: jtp
...
SERVICE_NAME   = "monitoring_system_bulk"
SERVICE_PORT   = 8159
...
def service_base(gateway_url):
    return f"{gateway_url}/api/monitoring_system_bulk"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-monitoring_system_bulk",
        "X-Service-Name": "monitoring_system_bulk",
        "X-Domain": "monitoring",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "monitoring_system_bulk",
        "domain": "monitoring",
        "resource_tier": "small",
        "port": 8159,
        "harmony_target": 0.997,
