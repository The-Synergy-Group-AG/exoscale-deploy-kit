"""Performance tests for monitoring_system_bulk.
Port: 8159 | Rate limit: 1000 rpm
...
class MonitoringSystemBulkUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/monitoring_system_bulk/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/monitoring_system_bulk/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/monitoring_system_bulk/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/monitoring_system_bulk/health")
