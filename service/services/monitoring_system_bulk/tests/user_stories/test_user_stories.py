"""User Story Acceptance Tests — monitoring_system_bulk
US: US-097..US-0630 (89 stories) | Port: 8159 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/monitoring_system_bulk"
SERVICE_PORT  = 8159


class TestMonitoringSystemBulkUserStories:
