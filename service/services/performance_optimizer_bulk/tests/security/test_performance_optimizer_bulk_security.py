"""Security tests for performance_optimizer_bulk.
Port: 8145 | Encryption: advanced | Audit retention: 365 days
OWASP Top 10 — Plan 123 Phase 3 (7 security tests).
Variables from CENTRAL_VARIABLE_REGISTRY.
"""
import pytest, httpx

SERVICE_BASE  = "http://151.145.202.116:30671/api/performance_optimizer_bulk"
SERVICE_PORT  = 8145
ENC_LEVEL     = "advanced"


class TestPerformanceOptimizerBulkSecurity:
