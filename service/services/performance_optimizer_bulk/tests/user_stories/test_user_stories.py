"""User Story Acceptance Tests — performance_optimizer_bulk
US: US-097..US-0630 (89 stories) | Port: 8145 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/performance_optimizer_bulk"
SERVICE_PORT  = 8145


class TestPerformanceOptimizerBulkUserStories:
