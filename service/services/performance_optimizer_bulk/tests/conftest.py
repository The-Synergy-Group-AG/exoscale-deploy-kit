"""Shared test fixtures for performance_optimizer_bulk.
Domain: monitoring | Port: 8145 | NS: jtp
...
SERVICE_NAME   = "performance_optimizer_bulk"
SERVICE_PORT   = 8145
...
def service_name():
    return "performance_optimizer_bulk"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/performance_optimizer_bulk"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-performance_optimizer_bulk",
        "X-Service-Name": "performance_optimizer_bulk",
        "X-Domain": "monitoring",
    }
