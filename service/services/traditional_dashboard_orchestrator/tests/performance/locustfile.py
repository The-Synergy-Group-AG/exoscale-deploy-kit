"""Performance tests for traditional_dashboard_orchestrator.
Port: 8158 | Rate limit: 1000 rpm
...
class TraditionalDashboardOrchestratorUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/traditional_dashboard_orchestrator/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/traditional_dashboard_orchestrator/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/traditional_dashboard_orchestrator/analytics/dashboard",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/traditional_dashboard_orchestrator/health")
