"""Shared test fixtures for traditional_dashboard_orchestrator.
Domain: analytics | Port: 8158 | NS: jtp
...
SERVICE_NAME   = "traditional_dashboard_orchestrator"
SERVICE_PORT   = 8158
...
def service_name():
    return "traditional_dashboard_orchestrator"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/traditional_dashboard_orchestrator"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-traditional_dashboard_orchestrator",
        "X-Service-Name": "traditional_dashboard_orchestrator",
        "X-Domain": "analytics",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "traditional_dashboard_orchestrator",
        "domain": "analytics",
        "resource_tier": "medium",
        "port": 8158,
        "harmony_target": 0.997,
