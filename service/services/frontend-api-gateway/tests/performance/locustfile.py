"""Performance tests for frontend-api-gateway.
Port: 8103 | Rate limit: 1000 rpm
...
class FrontendApiGatewayUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/frontend-api-gateway/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/frontend-api-gateway/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/frontend-api-gateway/api/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/frontend-api-gateway/health")
