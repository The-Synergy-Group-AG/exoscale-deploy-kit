"""Shared test fixtures for frontend-api-gateway.
Domain: frontend | Port: 8103 | NS: jtp
...
SERVICE_NAME   = "frontend-api-gateway"
SERVICE_PORT   = 8103
...
def service_base(gateway_url):
    return f"{gateway_url}/api/frontend-api-gateway"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-frontend-api-gateway",
        "X-Service-Name": "frontend-api-gateway",
        "X-Domain": "frontend",
    }
