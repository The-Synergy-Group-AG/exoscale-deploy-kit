"""Performance tests for test_integration_database_postgresql.
Port: 8272 | Rate limit: 1000 rpm
...
class TestIntegrationDatabasePostgresqlUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/test_integration_database_postgresql/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/test_integration_database_postgresql/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/test_integration_database_postgresql/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/test_integration_database_postgresql/health")
