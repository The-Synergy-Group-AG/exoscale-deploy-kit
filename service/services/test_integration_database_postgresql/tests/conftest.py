"""Shared test fixtures for test_integration_database_postgresql.
Domain: monitoring | Port: 8272 | NS: jtp
...
SERVICE_NAME   = "test_integration_database_postgresql"
SERVICE_PORT   = 8272
...
def service_name():
    return "test_integration_database_postgresql"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/test_integration_database_postgresql"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-test_integration_database_postgresql",
        "X-Service-Name": "test_integration_database_postgresql",
        "X-Domain": "monitoring",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "test_integration_database_postgresql",
        "domain": "monitoring",
        "resource_tier": "small",
        "port": 8272,
        "harmony_target": 0.997,
