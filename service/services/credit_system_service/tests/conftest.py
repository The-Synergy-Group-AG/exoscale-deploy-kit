"""Shared test fixtures for credit_system_service.
Domain: payment | Port: 8217 | NS: jtp
...
SERVICE_NAME   = "credit_system_service"
SERVICE_PORT   = 8217
...
def service_base(gateway_url):
    return f"{gateway_url}/api/credit_system_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-credit_system_service",
        "X-Service-Name": "credit_system_service",
        "X-Domain": "payment",
    }
