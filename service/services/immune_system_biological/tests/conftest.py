"""Shared test fixtures for immune_system_biological.
Domain: biological | Port: 8192 | NS: jtp
...
SERVICE_NAME   = "immune_system_biological"
SERVICE_PORT   = 8192
...
def service_name():
    return "immune_system_biological"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/immune_system_biological"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-immune_system_biological",
        "X-Service-Name": "immune_system_biological",
        "X-Domain": "biological",
    }
