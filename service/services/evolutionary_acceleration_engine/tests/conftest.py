"""Shared test fixtures for evolutionary_acceleration_engine.
Domain: biological | Port: 8177 | NS: jtp
...
SERVICE_NAME   = "evolutionary_acceleration_engine"
SERVICE_PORT   = 8177
...
def service_name():
    return "evolutionary_acceleration_engine"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/evolutionary_acceleration_engine"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-evolutionary_acceleration_engine",
        "X-Service-Name": "evolutionary_acceleration_engine",
        "X-Domain": "biological",
    }
