"""User Story Acceptance Tests — computer_vision_service
US: US-410..US-0683 (90 stories) | Port: 8137 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/computer_vision_service"
SERVICE_PORT  = 8137


class TestComputerVisionServiceUserStories:
