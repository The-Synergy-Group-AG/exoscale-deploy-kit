"""Performance tests for computer_vision_service.
Port: 8137 | Rate limit: 1000 rpm
...
class ComputerVisionServiceUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/computer_vision_service/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/computer_vision_service/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.post("/api/computer_vision_service/ai/process",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/computer_vision_service/health")
