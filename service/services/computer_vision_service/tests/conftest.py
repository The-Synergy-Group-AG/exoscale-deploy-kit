"""Shared test fixtures for computer_vision_service.
Domain: ai | Port: 8137 | NS: jtp
...
SERVICE_NAME   = "computer_vision_service"
SERVICE_PORT   = 8137
...
def service_base(gateway_url):
    return f"{gateway_url}/api/computer_vision_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-computer_vision_service",
        "X-Service-Name": "computer_vision_service",
        "X-Domain": "ai",
    }
