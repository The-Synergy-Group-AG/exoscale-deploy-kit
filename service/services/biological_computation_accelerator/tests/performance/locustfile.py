"""Performance tests for biological_computation_accelerator.
Port: 8231 | Rate limit: 1000 rpm
...
class BiologicalComputationAcceleratorUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/biological_computation_accelerator/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/biological_computation_accelerator/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/biological_computation_accelerator/biological/harmony",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/biological_computation_accelerator/health")
