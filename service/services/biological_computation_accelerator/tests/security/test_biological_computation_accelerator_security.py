"""Security tests for biological_computation_accelerator.
Port: 8231 | Encryption: advanced | Audit retention: 365 days
OWASP Top 10 — Plan 123 Phase 3 (7 security tests).
Variables from CENTRAL_VARIABLE_REGISTRY.
"""
import pytest, httpx

SERVICE_BASE  = "http://151.145.202.116:30671/api/biological_computation_accelerator"
SERVICE_PORT  = 8231
ENC_LEVEL     = "advanced"


class TestBiologicalComputationAcceleratorSecurity:
