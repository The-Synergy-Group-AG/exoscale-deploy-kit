"""Shared test fixtures for biological_computation_accelerator.
Domain: biological | Port: 8231 | NS: jtp
...
SERVICE_NAME   = "biological_computation_accelerator"
SERVICE_PORT   = 8231
...
def service_name():
    return "biological_computation_accelerator"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/biological_computation_accelerator"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-biological_computation_accelerator",
        "X-Service-Name": "biological_computation_accelerator",
        "X-Domain": "biological",
    }
