"""User Story Acceptance Tests — onboarding-frontend
US: US-324..US-0622 (35 stories) | Port: 8093 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/onboarding-frontend"
SERVICE_PORT  = 8093


class TestOnboardingFrontendUserStories:
