"""Shared test fixtures for onboarding-frontend.
Domain: frontend | Port: 8093 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/onboarding-frontend"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-onboarding-frontend",
        "X-Service-Name": "onboarding-frontend",
        "X-Domain": "frontend",
    }
