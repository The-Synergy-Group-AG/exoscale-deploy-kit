"""User Story Acceptance Tests — disaster_recovery_service
US: US-501..US-0708 (49 stories) | Port: 8096 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/disaster_recovery_service"
SERVICE_PORT  = 8096


class TestDisasterRecoveryServiceUserStories:
