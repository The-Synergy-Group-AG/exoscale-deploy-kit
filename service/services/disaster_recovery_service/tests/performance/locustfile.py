"""Performance tests for disaster_recovery_service.
Port: 8096 | Rate limit: 1000 rpm
...
class DisasterRecoveryServiceUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/disaster_recovery_service/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/disaster_recovery_service/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/disaster_recovery_service/backup/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/disaster_recovery_service/health")
