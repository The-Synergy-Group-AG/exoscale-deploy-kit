"""User Story Acceptance Tests — api_gateway_manager
US: US-001..US-0601 (241 stories) | Port: 8102 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/api_gateway_manager"
SERVICE_PORT  = 8102


class TestApiGatewayManagerUserStories:
