"""Shared test fixtures for data_visualization_service.
Domain: analytics | Port: 8275 | NS: jtp
...
SERVICE_NAME   = "data_visualization_service"
SERVICE_PORT   = 8275
...
def service_base(gateway_url):
    return f"{gateway_url}/api/data_visualization_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-data_visualization_service",
        "X-Service-Name": "data_visualization_service",
        "X-Domain": "analytics",
    }
