"""Performance tests for data_visualization_service.
Port: 8275 | Rate limit: 1000 rpm
...
class DataVisualizationServiceUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/data_visualization_service/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/data_visualization_service/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/data_visualization_service/analytics/dashboard",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/data_visualization_service/health")
