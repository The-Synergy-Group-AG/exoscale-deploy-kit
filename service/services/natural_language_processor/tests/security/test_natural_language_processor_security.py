"""Security tests for natural_language_processor.
Port: 8300 | Encryption: advanced | Audit retention: 365 days
OWASP Top 10 — Plan 123 Phase 3 (7 security tests).
Variables from CENTRAL_VARIABLE_REGISTRY.
"""
import pytest, httpx

SERVICE_BASE  = "http://151.145.202.116:30671/api/natural_language_processor"
SERVICE_PORT  = 8300
ENC_LEVEL     = "advanced"


class TestNaturalLanguageProcessorSecurity:
