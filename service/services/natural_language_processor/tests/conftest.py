"""Shared test fixtures for natural_language_processor.
Domain: authentication | Port: 8300 | NS: jtp
...
SERVICE_NAME   = "natural_language_processor"
SERVICE_PORT   = 8300
...
def service_name():
    return "natural_language_processor"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/natural_language_processor"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-natural_language_processor",
        "X-Service-Name": "natural_language_processor",
