"""Performance tests for real_time_data_refresher.
Port: 8126 | Rate limit: 1000 rpm
...
class RealTimeDataRefresherUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/real_time_data_refresher/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/real_time_data_refresher/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.post("/api/real_time_data_refresher/ai/process",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/real_time_data_refresher/health")
