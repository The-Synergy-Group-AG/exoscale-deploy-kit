"""Shared test fixtures for real_time_data_refresher.
Domain: ai | Port: 8126 | NS: jtp
...
SERVICE_NAME   = "real_time_data_refresher"
SERVICE_PORT   = 8126
...
def service_name():
    return "real_time_data_refresher"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/real_time_data_refresher"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-real_time_data_refresher",
        "X-Service-Name": "real_time_data_refresher",
        "X-Domain": "ai",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "real_time_data_refresher",
        "domain": "ai",
        "resource_tier": "large",
        "port": 8126,
        "harmony_target": 0.997,
