"""Shared test fixtures for execute_complete_369_user_stories.
Domain: general | Port: 8152 | NS: jtp
...
SERVICE_NAME   = "execute_complete_369_user_stories"
SERVICE_PORT   = 8152
...
def service_name():
    return "execute_complete_369_user_stories"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/execute_complete_369_user_stories"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-execute_complete_369_user_stories",
        "X-Service-Name": "execute_complete_369_user_stories",
        "X-Domain": "general",
    }
