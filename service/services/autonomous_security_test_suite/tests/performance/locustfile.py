"""Performance tests for autonomous_security_test_suite.
Port: 8151 | Rate limit: 1000 rpm
...
class AutonomousSecurityTestSuiteUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/autonomous_security_test_suite/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/autonomous_security_test_suite/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/autonomous_security_test_suite/security/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/autonomous_security_test_suite/health")
