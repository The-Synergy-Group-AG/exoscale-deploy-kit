"""Shared test fixtures for autonomous_security_test_suite.
Domain: security | Port: 8151 | NS: jtp
...
SERVICE_NAME   = "autonomous_security_test_suite"
SERVICE_PORT   = 8151
...
def service_name():
    return "autonomous_security_test_suite"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/autonomous_security_test_suite"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-autonomous_security_test_suite",
        "X-Service-Name": "autonomous_security_test_suite",
        "X-Domain": "security",
    }
