"""User Story Acceptance Tests — autonomous_security_test_suite
US: US-001..US-0601 (241 stories) | Port: 8151 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/autonomous_security_test_suite"
SERVICE_PORT  = 8151


class TestAutonomousSecurityTestSuiteUserStories:
