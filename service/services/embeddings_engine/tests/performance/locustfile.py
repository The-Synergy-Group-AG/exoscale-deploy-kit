"""Performance tests for embeddings_engine.
Port: 8166 | Rate limit: 1000 rpm
...
class EmbeddingsEngineUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/embeddings_engine/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/embeddings_engine/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.post("/api/embeddings_engine/ai/process",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/embeddings_engine/health")
