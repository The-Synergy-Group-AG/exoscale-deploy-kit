"""User Story Acceptance Tests — embeddings_engine
US: US-410..US-0683 (90 stories) | Port: 8166 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/embeddings_engine"
SERVICE_PORT  = 8166


class TestEmbeddingsEngineUserStories:
