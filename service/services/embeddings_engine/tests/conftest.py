"""Shared test fixtures for embeddings_engine.
Domain: ai | Port: 8166 | NS: jtp
...
SERVICE_NAME   = "embeddings_engine"
SERVICE_PORT   = 8166
...
def service_base(gateway_url):
    return f"{gateway_url}/api/embeddings_engine"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-embeddings_engine",
        "X-Service-Name": "embeddings_engine",
        "X-Domain": "ai",
    }
