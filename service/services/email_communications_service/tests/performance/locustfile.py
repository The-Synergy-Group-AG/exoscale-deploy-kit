"""Performance tests for email_communications_service.
Port: 8195 | Rate limit: 1000 rpm
...
class EmailCommunicationsServiceUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/email_communications_service/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/email_communications_service/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/email_communications_service/notifications",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/email_communications_service/health")
