"""Shared test fixtures for email_communications_service.
Domain: notification | Port: 8195 | NS: jtp
...
SERVICE_NAME   = "email_communications_service"
SERVICE_PORT   = 8195
...
def service_name():
    return "email_communications_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/email_communications_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-email_communications_service",
        "X-Service-Name": "email_communications_service",
