"""Performance tests for webhook_integrations_service.
Port: 8206 | Rate limit: 1000 rpm
...
class WebhookIntegrationsServiceUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/webhook_integrations_service/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/webhook_integrations_service/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/webhook_integrations_service/workflows",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/webhook_integrations_service/health")
