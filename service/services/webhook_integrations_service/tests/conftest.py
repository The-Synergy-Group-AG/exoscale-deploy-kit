"""Shared test fixtures for webhook_integrations_service.
Domain: workflow | Port: 8206 | NS: jtp
...
SERVICE_NAME   = "webhook_integrations_service"
SERVICE_PORT   = 8206
...
def service_name():
    return "webhook_integrations_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/webhook_integrations_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-webhook_integrations_service",
        "X-Service-Name": "webhook_integrations_service",
        "X-Domain": "workflow",
    }
