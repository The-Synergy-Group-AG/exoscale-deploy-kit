"""Shared test fixtures for encryption_service_communication.
Domain: security | Port: 8132 | NS: jtp
...
SERVICE_NAME   = "encryption_service_communication"
SERVICE_PORT   = 8132
...
def service_name():
    return "encryption_service_communication"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/encryption_service_communication"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-encryption_service_communication",
        "X-Service-Name": "encryption_service_communication",
        "X-Domain": "security",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "encryption_service_communication",
        "domain": "security",
        "resource_tier": "large",
        "port": 8132,
        "harmony_target": 0.997,
