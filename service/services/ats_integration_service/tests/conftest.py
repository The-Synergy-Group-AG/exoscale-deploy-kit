"""Shared test fixtures for ats_integration_service.
Domain: workflow | Port: 8112 | NS: jtp
...
SERVICE_NAME   = "ats_integration_service"
SERVICE_PORT   = 8112
...
def service_name():
    return "ats_integration_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/ats_integration_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-ats_integration_service",
        "X-Service-Name": "ats_integration_service",
        "X-Domain": "workflow",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "ats_integration_service",
        "domain": "workflow",
        "resource_tier": "medium",
        "port": 8112,
        "harmony_target": 0.997,
