"""User Story Acceptance Tests — ats_integration_service
US: US-001..US-0601 (241 stories) | Port: 8112 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/ats_integration_service"
SERVICE_PORT  = 8112


class TestAtsIntegrationServiceUserStories:
