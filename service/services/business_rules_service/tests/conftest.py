"""Shared test fixtures for business_rules_service.
Domain: workflow | Port: 8161 | NS: jtp
...
SERVICE_NAME   = "business_rules_service"
SERVICE_PORT   = 8161
...
def service_base(gateway_url):
    return f"{gateway_url}/api/business_rules_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-business_rules_service",
        "X-Service-Name": "business_rules_service",
        "X-Domain": "workflow",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "business_rules_service",
        "domain": "workflow",
        "resource_tier": "medium",
        "port": 8161,
        "harmony_target": 0.997,
