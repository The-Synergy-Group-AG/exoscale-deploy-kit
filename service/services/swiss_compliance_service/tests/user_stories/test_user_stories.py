"""User Story Acceptance Tests — swiss_compliance_service
US: US-357..US-0611 (55 stories) | Port: 8104 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/swiss_compliance_service"
SERVICE_PORT  = 8104


class TestSwissComplianceServiceUserStories:
