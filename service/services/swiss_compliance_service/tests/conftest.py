"""Shared test fixtures for swiss_compliance_service.
Domain: compliance | Port: 8104 | NS: jtp
...
SERVICE_NAME   = "swiss_compliance_service"
SERVICE_PORT   = 8104
...
def service_name():
    return "swiss_compliance_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/swiss_compliance_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-swiss_compliance_service",
        "X-Service-Name": "swiss_compliance_service",
        "X-Domain": "compliance",
    }
