"""Shared test fixtures for performance_regression_test_service.
Domain: monitoring | Port: 8248 | NS: jtp
...
SERVICE_NAME   = "performance_regression_test_service"
SERVICE_PORT   = 8248
...
def service_name():
    return "performance_regression_test_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/performance_regression_test_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-performance_regression_test_service",
        "X-Service-Name": "performance_regression_test_service",
        "X-Domain": "monitoring",
    }
