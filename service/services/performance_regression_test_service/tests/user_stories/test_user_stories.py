"""User Story Acceptance Tests — performance_regression_test_service
US: US-097..US-0630 (89 stories) | Port: 8248 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/performance_regression_test_service"
SERVICE_PORT  = 8248


class TestPerformanceRegressionTestServiceUserStories:
