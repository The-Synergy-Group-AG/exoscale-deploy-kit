"""Shared test fixtures for ultimate_biological_harmony_bulk.
Domain: biological | Port: 8238 | NS: jtp
...
SERVICE_NAME   = "ultimate_biological_harmony_bulk"
SERVICE_PORT   = 8238
...
def service_name():
    return "ultimate_biological_harmony_bulk"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/ultimate_biological_harmony_bulk"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-ultimate_biological_harmony_bulk",
        "X-Service-Name": "ultimate_biological_harmony_bulk",
        "X-Domain": "biological",
    }
