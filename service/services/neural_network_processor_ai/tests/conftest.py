"""Shared test fixtures for neural_network_processor_ai.
Domain: authentication | Port: 8219 | NS: jtp
...
SERVICE_NAME   = "neural_network_processor_ai"
SERVICE_PORT   = 8219
...
def service_name():
    return "neural_network_processor_ai"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/neural_network_processor_ai"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-neural_network_processor_ai",
        "X-Service-Name": "neural_network_processor_ai",
...
def expected_service_meta():
    ...
    return {
        "service": "neural_network_processor_ai",
