"""Shared test fixtures for test_real_time_communication_validation.
Domain: monitoring | Port: 8141 | NS: jtp
...
SERVICE_NAME   = "test_real_time_communication_validation"
SERVICE_PORT   = 8141
...
def service_name():
    return "test_real_time_communication_validation"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/test_real_time_communication_validation"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-test_real_time_communication_validation",
        "X-Service-Name": "test_real_time_communication_validation",
        "X-Domain": "monitoring",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "test_real_time_communication_validation",
        "domain": "monitoring",
        "resource_tier": "small",
        "port": 8141,
        "harmony_target": 0.997,
