"""Performance tests for payment_processor_service.
Port: 8172 | Rate limit: 1000 rpm
...
class PaymentProcessorServiceUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/payment_processor_service/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/payment_processor_service/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/payment_processor_service/auth/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/payment_processor_service/health")
