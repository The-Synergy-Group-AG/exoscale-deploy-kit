"""Shared test fixtures for payment_processor_service.
Domain: authentication | Port: 8172 | NS: jtp
...
SERVICE_NAME   = "payment_processor_service"
SERVICE_PORT   = 8172
...
def service_base(gateway_url):
    return f"{gateway_url}/api/payment_processor_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-payment_processor_service",
        "X-Service-Name": "payment_processor_service",
...
def expected_service_meta():
    ...
    return {
        "service": "payment_processor_service",
