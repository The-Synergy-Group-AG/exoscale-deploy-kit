"""Shared test fixtures for skeletal_system.
Domain: biological | Port: 8222 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/skeletal_system"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-skeletal_system",
        "X-Service-Name": "skeletal_system",
        "X-Domain": "biological",
    }
