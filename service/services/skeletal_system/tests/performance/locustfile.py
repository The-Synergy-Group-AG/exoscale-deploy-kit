"""Performance tests for skeletal_system.
Port: 8222 | Rate limit: 1000 rpm
...
class SkeletalSystemUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/skeletal_system/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/skeletal_system/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/skeletal_system/biological/harmony",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/skeletal_system/health")
