"""User Story Acceptance Tests — skeletal_system
US: US-143..US-279 (115 stories) | Port: 8222 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/skeletal_system"
SERVICE_PORT  = 8222


class TestSkeletalSystemUserStories:
