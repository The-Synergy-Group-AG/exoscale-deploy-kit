"""Shared test fixtures for biological_consciousness_adapter.
Domain: biological | Port: 8147 | NS: jtp
...
SERVICE_NAME   = "biological_consciousness_adapter"
SERVICE_PORT   = 8147
...
def service_name():
    return "biological_consciousness_adapter"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/biological_consciousness_adapter"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-biological_consciousness_adapter",
        "X-Service-Name": "biological_consciousness_adapter",
        "X-Domain": "biological",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "biological_consciousness_adapter",
        "domain": "biological",
        "resource_tier": "large",
        "port": 8147,
        "harmony_target": 0.997,
