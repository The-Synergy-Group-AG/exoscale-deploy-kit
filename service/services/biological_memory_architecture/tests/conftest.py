"""Shared test fixtures for biological_memory_architecture.
Domain: biological | Port: 8264 | NS: jtp
...
SERVICE_NAME   = "biological_memory_architecture"
SERVICE_PORT   = 8264
...
def service_name():
    return "biological_memory_architecture"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/biological_memory_architecture"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-biological_memory_architecture",
        "X-Service-Name": "biological_memory_architecture",
        "X-Domain": "biological",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "biological_memory_architecture",
        "domain": "biological",
        "resource_tier": "large",
        "port": 8264,
        "harmony_target": 0.997,
