"""Shared test fixtures for endocrine_system.
Domain: document | Port: 8249 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/endocrine_system"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-endocrine_system",
        "X-Service-Name": "endocrine_system",
        "X-Domain": "document",
    }
