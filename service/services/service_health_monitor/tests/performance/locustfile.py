"""Performance tests for service_health_monitor.
Port: 8250 | Rate limit: 1000 rpm
...
class ServiceHealthMonitorUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/service_health_monitor/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/service_health_monitor/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/service_health_monitor/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/service_health_monitor/health")
