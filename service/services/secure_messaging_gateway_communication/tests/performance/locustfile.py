"""Performance tests for secure_messaging_gateway_communication.
Port: 8226 | Rate limit: 1000 rpm
...
class SecureMessagingGatewayCommunicationUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/secure_messaging_gateway_communication/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/secure_messaging_gateway_communication/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/secure_messaging_gateway_communication/security/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/secure_messaging_gateway_communication/health")
