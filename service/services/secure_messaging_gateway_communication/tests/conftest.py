"""Shared test fixtures for secure_messaging_gateway_communication.
Domain: security | Port: 8226 | NS: jtp
...
SERVICE_NAME   = "secure_messaging_gateway_communication"
SERVICE_PORT   = 8226
...
def service_name():
    return "secure_messaging_gateway_communication"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/secure_messaging_gateway_communication"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-secure_messaging_gateway_communication",
        "X-Service-Name": "secure_messaging_gateway_communication",
        "X-Domain": "security",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "secure_messaging_gateway_communication",
        "domain": "security",
        "resource_tier": "large",
        "port": 8226,
        "harmony_target": 0.997,
