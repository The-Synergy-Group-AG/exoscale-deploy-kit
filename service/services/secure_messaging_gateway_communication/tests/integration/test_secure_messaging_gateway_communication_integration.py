"""Integration tests for secure_messaging_gateway_communication.
Port: 8226 | Tier: large | Namespace: jtp
...
class TestSecureMessagingGatewayCommunicationIntegration:
