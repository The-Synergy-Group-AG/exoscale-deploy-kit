"""Shared test fixtures for payment_service.
Domain: payment | Port: 8268 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/payment_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-payment_service",
        "X-Service-Name": "payment_service",
        "X-Domain": "payment",
    }
