"""Shared test fixtures for shared-components-library-frontend.
Domain: frontend | Port: 8144 | NS: jtp
...
SERVICE_NAME   = "shared-components-library-frontend"
SERVICE_PORT   = 8144
...
def service_name():
    return "shared-components-library-frontend"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/shared-components-library-frontend"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-shared-components-library-frontend",
        "X-Service-Name": "shared-components-library-frontend",
        "X-Domain": "frontend",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "shared-components-library-frontend",
        "domain": "frontend",
        "resource_tier": "small",
        "port": 8144,
        "harmony_target": 0.997,
