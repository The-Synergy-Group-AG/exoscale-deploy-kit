"""Performance tests for shared-components-library-frontend.
Port: 8144 | Rate limit: 1000 rpm
...
class SharedComponentsLibraryFrontendUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/shared-components-library-frontend/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/shared-components-library-frontend/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/shared-components-library-frontend/api/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/shared-components-library-frontend/health")
