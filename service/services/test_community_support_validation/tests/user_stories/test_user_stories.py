"""User Story Acceptance Tests — test_community_support_validation
US: US-097..US-0630 (89 stories) | Port: 8295 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/test_community_support_validation"
SERVICE_PORT  = 8295


class TestTestCommunitySupportValidationUserStories:
