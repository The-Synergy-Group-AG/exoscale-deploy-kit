"""Performance tests for test_community_support_validation.
Port: 8295 | Rate limit: 1000 rpm
...
class TestCommunitySupportValidationUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/test_community_support_validation/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/test_community_support_validation/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/test_community_support_validation/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/test_community_support_validation/health")
