"""Shared test fixtures for test_community_support_validation.
Domain: monitoring | Port: 8295 | NS: jtp
...
SERVICE_NAME   = "test_community_support_validation"
SERVICE_PORT   = 8295
...
def service_name():
    return "test_community_support_validation"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/test_community_support_validation"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-test_community_support_validation",
        "X-Service-Name": "test_community_support_validation",
        "X-Domain": "monitoring",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "test_community_support_validation",
        "domain": "monitoring",
        "resource_tier": "small",
        "port": 8295,
        "harmony_target": 0.997,
