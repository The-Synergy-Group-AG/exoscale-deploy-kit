"""Shared test fixtures for immune_system.
Domain: biological | Port: 8134 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/immune_system"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-immune_system",
        "X-Service-Name": "immune_system",
        "X-Domain": "biological",
    }
