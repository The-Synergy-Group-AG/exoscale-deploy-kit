"""Performance tests for cv_documents_infrastructure.
Port: 8283 | Rate limit: 1000 rpm
...
class CvDocumentsInfrastructureUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/cv_documents_infrastructure/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/cv_documents_infrastructure/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/cv_documents_infrastructure/jobs",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/cv_documents_infrastructure/health")
