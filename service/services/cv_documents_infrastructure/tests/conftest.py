"""Shared test fixtures for cv_documents_infrastructure.
Domain: career | Port: 8283 | NS: jtp
...
SERVICE_NAME   = "cv_documents_infrastructure"
SERVICE_PORT   = 8283
...
def service_name():
    return "cv_documents_infrastructure"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/cv_documents_infrastructure"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-cv_documents_infrastructure",
        "X-Service-Name": "cv_documents_infrastructure",
        "X-Domain": "career",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "cv_documents_infrastructure",
        "domain": "career",
        "resource_tier": "medium",
        "port": 8283,
        "harmony_target": 0.997,
