"""User Story Acceptance Tests — cv_documents_infrastructure
US: US-280..US-323 (28 stories) | Port: 8283 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/cv_documents_infrastructure"
SERVICE_PORT  = 8283


class TestCvDocumentsInfrastructureUserStories:
