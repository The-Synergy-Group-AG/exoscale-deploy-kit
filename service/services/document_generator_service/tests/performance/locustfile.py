"""Performance tests for document_generator_service.
Port: 8098 | Rate limit: 1000 rpm
...
class DocumentGeneratorServiceUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/document_generator_service/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/document_generator_service/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/document_generator_service/documents",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/document_generator_service/health")
