"""User Story Acceptance Tests — cognitive_assistance_engine
US: US-410..US-0683 (90 stories) | Port: 8189 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/cognitive_assistance_engine"
SERVICE_PORT  = 8189


class TestCognitiveAssistanceEngineUserStories:
