"""Performance tests for service_registry.
Port: 8131 | Rate limit: 1000 rpm
...
class ServiceRegistryUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/service_registry/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/service_registry/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/service_registry/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/service_registry/health")
