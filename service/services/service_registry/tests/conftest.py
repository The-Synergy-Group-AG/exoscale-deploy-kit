"""Shared test fixtures for service_registry.
Domain: monitoring | Port: 8131 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/service_registry"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-service_registry",
        "X-Service-Name": "service_registry",
        "X-Domain": "monitoring",
    }
