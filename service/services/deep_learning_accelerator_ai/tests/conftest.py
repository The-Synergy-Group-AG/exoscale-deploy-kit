"""Shared test fixtures for deep_learning_accelerator_ai.
Domain: ai | Port: 8170 | NS: jtp
...
SERVICE_NAME   = "deep_learning_accelerator_ai"
SERVICE_PORT   = 8170
...
def service_name():
    return "deep_learning_accelerator_ai"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/deep_learning_accelerator_ai"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-deep_learning_accelerator_ai",
        "X-Service-Name": "deep_learning_accelerator_ai",
        "X-Domain": "ai",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "deep_learning_accelerator_ai",
        "domain": "ai",
        "resource_tier": "large",
        "port": 8170,
        "harmony_target": 0.997,
