"""Performance tests for interview-prep-frontend.
Port: 8258 | Rate limit: 1000 rpm
...
class InterviewPrepFrontendUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/interview-prep-frontend/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/interview-prep-frontend/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/interview-prep-frontend/api/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/interview-prep-frontend/health")
