"""Shared test fixtures for interview-prep-frontend.
Domain: frontend | Port: 8258 | NS: jtp
...
SERVICE_NAME   = "interview-prep-frontend"
SERVICE_PORT   = 8258
...
def service_name():
    return "interview-prep-frontend"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/interview-prep-frontend"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-interview-prep-frontend",
        "X-Service-Name": "interview-prep-frontend",
        "X-Domain": "frontend",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "interview-prep-frontend",
        "domain": "frontend",
        "resource_tier": "small",
        "port": 8258,
        "harmony_target": 0.997,
