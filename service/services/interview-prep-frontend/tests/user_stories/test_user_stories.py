"""User Story Acceptance Tests — interview-prep-frontend
US: US-324..US-0622 (35 stories) | Port: 8258 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/interview-prep-frontend"
SERVICE_PORT  = 8258


class TestInterviewPrepFrontendUserStories:
