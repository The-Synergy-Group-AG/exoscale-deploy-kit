"""Shared test fixtures for security_gateway.
Domain: security | Port: 8198 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/security_gateway"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-security_gateway",
        "X-Service-Name": "security_gateway",
        "X-Domain": "security",
    }
