"""Performance tests for security_gateway.
Port: 8198 | Rate limit: 1000 rpm
...
class SecurityGatewayUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/security_gateway/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/security_gateway/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/security_gateway/security/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/security_gateway/health")
