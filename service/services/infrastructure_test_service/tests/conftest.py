"""Shared test fixtures for infrastructure_test_service.
Domain: monitoring | Port: 8117 | NS: jtp
...
SERVICE_NAME   = "infrastructure_test_service"
SERVICE_PORT   = 8117
...
def service_name():
    return "infrastructure_test_service"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/infrastructure_test_service"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-infrastructure_test_service",
        "X-Service-Name": "infrastructure_test_service",
        "X-Domain": "monitoring",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "infrastructure_test_service",
        "domain": "monitoring",
        "resource_tier": "small",
        "port": 8117,
        "harmony_target": 0.997,
