"""User Story Acceptance Tests — infrastructure_test_service
US: US-097..US-0630 (89 stories) | Port: 8117 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/infrastructure_test_service"
SERVICE_PORT  = 8117


class TestInfrastructureTestServiceUserStories:
