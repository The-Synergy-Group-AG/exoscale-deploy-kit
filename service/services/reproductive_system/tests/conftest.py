"""Shared test fixtures for reproductive_system.
Domain: biological | Port: 8299 | NS: jtp
...
SERVICE_NAME   = "reproductive_system"
SERVICE_PORT   = 8299
...
def service_base(gateway_url):
    return f"{gateway_url}/api/reproductive_system"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-reproductive_system",
        "X-Service-Name": "reproductive_system",
        "X-Domain": "biological",
    }
