"""User Story Acceptance Tests — reproductive_system
US: US-143..US-279 (115 stories) | Port: 8299 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/reproductive_system"
SERVICE_PORT  = 8299


class TestReproductiveSystemUserStories:
