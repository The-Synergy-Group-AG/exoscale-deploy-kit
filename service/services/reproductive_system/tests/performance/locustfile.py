"""Performance tests for reproductive_system.
Port: 8299 | Rate limit: 1000 rpm
...
class ReproductiveSystemUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/reproductive_system/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/reproductive_system/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/reproductive_system/biological/harmony",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/reproductive_system/health")
