"""Shared test fixtures for credits-redemption-frontend.
Domain: frontend | Port: 8108 | NS: jtp
...
SERVICE_NAME   = "credits-redemption-frontend"
SERVICE_PORT   = 8108
...
def service_name():
    return "credits-redemption-frontend"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/credits-redemption-frontend"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-credits-redemption-frontend",
        "X-Service-Name": "credits-redemption-frontend",
        "X-Domain": "frontend",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "credits-redemption-frontend",
        "domain": "frontend",
        "resource_tier": "small",
        "port": 8108,
        "harmony_target": 0.997,
