"""Shared test fixtures for backup_system.
Domain: backup | Port: 8171 | NS: jtp
...
def service_base(gateway_url):
    return f"{gateway_url}/api/backup_system"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-backup_system",
        "X-Service-Name": "backup_system",
        "X-Domain": "backup",
    }
