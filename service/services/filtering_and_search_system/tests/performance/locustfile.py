"""Performance tests for filtering_and_search_system.
Port: 8139 | Rate limit: 1000 rpm
...
class FilteringAndSearchSystemUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/filtering_and_search_system/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/filtering_and_search_system/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/filtering_and_search_system/workflows",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/filtering_and_search_system/health")
