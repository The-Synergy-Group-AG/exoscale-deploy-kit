"""Shared test fixtures for filtering_and_search_system.
Domain: workflow | Port: 8139 | NS: jtp
...
SERVICE_NAME   = "filtering_and_search_system"
SERVICE_PORT   = 8139
...
def service_name():
    return "filtering_and_search_system"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/filtering_and_search_system"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-filtering_and_search_system",
        "X-Service-Name": "filtering_and_search_system",
        "X-Domain": "workflow",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "filtering_and_search_system",
        "domain": "workflow",
        "resource_tier": "medium",
        "port": 8139,
        "harmony_target": 0.997,
