"""Shared test fixtures for transcendence_achievement_monitor.
Domain: gamification | Port: 8168 | NS: jtp
...
SERVICE_NAME   = "transcendence_achievement_monitor"
SERVICE_PORT   = 8168
GATEWAY_URL    = "http://151.145.202.116:30671"
SERVICE_DOMAIN = "gamification"
...
def service_name():
    return "transcendence_achievement_monitor"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/transcendence_achievement_monitor"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-transcendence_achievement_monitor",
        "X-Service-Name": "transcendence_achievement_monitor",
        "X-Domain": "gamification",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "transcendence_achievement_monitor",
        "domain": "gamification",
        "resource_tier": "small",
        "port": 8168,
        "harmony_target": 0.997,
