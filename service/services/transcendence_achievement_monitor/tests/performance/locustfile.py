"""Performance tests for transcendence_achievement_monitor.
Port: 8168 | Rate limit: 1000 rpm
...
class TranscendenceAchievementMonitorUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/transcendence_achievement_monitor/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/transcendence_achievement_monitor/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/transcendence_achievement_monitor/leaderboard",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/transcendence_achievement_monitor/health")
