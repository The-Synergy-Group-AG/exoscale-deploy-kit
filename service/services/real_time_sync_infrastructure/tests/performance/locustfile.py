"""Performance tests for real_time_sync_infrastructure.
Port: 8188 | Rate limit: 1000 rpm
...
class RealTimeSyncInfrastructureUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/real_time_sync_infrastructure/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/real_time_sync_infrastructure/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/real_time_sync_infrastructure/workflows",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/real_time_sync_infrastructure/health")
