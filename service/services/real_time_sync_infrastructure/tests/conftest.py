"""Shared test fixtures for real_time_sync_infrastructure.
Domain: workflow | Port: 8188 | NS: jtp
...
SERVICE_NAME   = "real_time_sync_infrastructure"
SERVICE_PORT   = 8188
...
def service_name():
    return "real_time_sync_infrastructure"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/real_time_sync_infrastructure"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-real_time_sync_infrastructure",
        "X-Service-Name": "real_time_sync_infrastructure",
        "X-Domain": "workflow",
    }
