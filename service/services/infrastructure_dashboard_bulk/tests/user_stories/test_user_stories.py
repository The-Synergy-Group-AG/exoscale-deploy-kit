"""User Story Acceptance Tests — infrastructure_dashboard_bulk
US: US-097..US-0630 (89 stories) | Port: 8086 | Harmony: 0.997
...
SERVICE_BASE  = f"{GATEWAY_URL}/api/infrastructure_dashboard_bulk"
SERVICE_PORT  = 8086


class TestInfrastructureDashboardBulkUserStories:
