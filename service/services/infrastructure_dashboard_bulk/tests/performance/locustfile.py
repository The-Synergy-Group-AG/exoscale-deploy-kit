"""Performance tests for infrastructure_dashboard_bulk.
Port: 8086 | Rate limit: 1000 rpm
...
class InfrastructureDashboardBulkUser(HttpUser):
    ...
    def health_check(self):
        ...
        with self.client.get("/api/infrastructure_dashboard_bulk/health", catch_response=True) as r:
    ...
    def service_root(self):
        ...
        with self.client.get("/api/infrastructure_dashboard_bulk/", catch_response=True) as r:
            if r.status_code != 200: r.failure(f"Failed: {r.status_code}")
    ...
    def business_endpoint(self):
        ...
        with self.client.get("/api/infrastructure_dashboard_bulk/status",
    ...
    def on_start(self):
        ...
        r = self.client.get("/api/infrastructure_dashboard_bulk/health")
