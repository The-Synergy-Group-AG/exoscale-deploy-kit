"""Shared test fixtures for infrastructure_dashboard_bulk.
Domain: monitoring | Port: 8086 | NS: jtp
...
SERVICE_NAME   = "infrastructure_dashboard_bulk"
SERVICE_PORT   = 8086
...
def service_name():
    return "infrastructure_dashboard_bulk"
...
def service_base(gateway_url):
    return f"{gateway_url}/api/infrastructure_dashboard_bulk"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-infrastructure_dashboard_bulk",
        "X-Service-Name": "infrastructure_dashboard_bulk",
        "X-Domain": "monitoring",
    }
...
def expected_service_meta():
    ...
    return {
        "service": "infrastructure_dashboard_bulk",
        "domain": "monitoring",
        "resource_tier": "small",
        "port": 8086,
        "harmony_target": 0.997,
