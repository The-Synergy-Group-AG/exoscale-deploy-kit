"""Shared test fixtures for backup_system_bulk.
Domain: backup | Port: 8095 | NS: jtp
...
SERVICE_NAME   = "backup_system_bulk"
SERVICE_PORT   = 8095
...
def service_base(gateway_url):
    return f"{gateway_url}/api/backup_system_bulk"
...
def auth_headers():
    ...
    return {
        "Authorization": "Bearer test-token-jtp-backup_system_bulk",
        "X-Service-Name": "backup_system_bulk",
        "X-Domain": "backup",
    }
